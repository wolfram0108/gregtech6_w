...
Проверено тремя независимыми сборками, причём один раз настройки намеренно отключались, чтобы
убедиться, что проверка вообще способна провалиться: без них тот же исходник дал два разных jar.
