...
public class BlockLongDistWire extends BlockBaseMachineUpdate {
	...
	public void addInformation(ItemStack aStack, byte aMeta, Player aPlayer, List<String> aList, boolean aF3_H) {
		...
		aList.add(Chat.CYAN + LH.get(LH.WIRE_STATS_AMPERAGE) + LH.tt("UNLIMITED"));
	...
	public float getExplosionResistance(Entity aEntity, Level aWorld, int aX, int aY, int aZ, double eX, double eY, double eZ) {return 15;}
