...
public class Behavior_Spray_Color_Remover extends AbstractBehaviorDefault {
	...
	private static boolean decolorize(Level aWorld, int aX, int aY, int aZ, byte aSide) {
		...
		// 1.7.10 compared against the whole family block; since neo splits the family into separate blocks, this compares
		// against the family head via CS.Flattened instead.
