...
public class GT_Tool_Spade extends ToolStats {
	...
	public boolean isMinableBlock(Block aBlock, byte aMetaData) {
		...
		return (TOOL_shovel.equalsIgnoreCase(WD.harvestTool(aBlock, aMetaData)) && WD.getMaterial(aBlock) != Material.sand && WD.getMaterial(aBlock) != Material.snow && WD.getMaterial(aBlock) != Material.craftedSnow) || WD.getMaterial(aBlock) == Material.fire || WD.getMaterial(aBlock) == Material.grass || WD.getMaterial(aBlock) == Material.ground || WD.getMaterial(aBlock) == Material.clay;
	}
