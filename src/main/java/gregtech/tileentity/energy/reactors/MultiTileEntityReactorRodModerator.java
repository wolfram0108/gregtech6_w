...
public class MultiTileEntityReactorRodModerator extends MultiTileEntityReactorRodBase {
	...
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		...
		aList.add(LH.Chat.CYAN + LH.tt("Reflects neutrons back times the number of fuel rods touching when active"));
		aList.add(LH.Chat.CYAN + LH.tt("Touching Fuel Rods become moderated and moderate touching Fuel Rods"));
		aList.add(LH.Chat.CYAN + LH.tt("Moderated Fuel Rods can't be used for Breeding and only last a quarter as long"));
	}
