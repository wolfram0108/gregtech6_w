...
public class MultiTileEntityDustFunnel extends TileEntityBase07Paintable implements ITileEntityAdjacentInventoryUpdatable, IMTE_AddToolTips, IMTE_SyncDataShort {
	...
	public boolean onBlockActivated3(Player aPlayer, byte aSide, float aHitX, float aHitY, float aHitZ) {
		if (isServerSide() && SIDES_TOP[aSide] && canInsertItem2(0, aPlayer.inventory.getCurrentItem(), aSide)) ST.move(aPlayer.inventory, this, aPlayer.inventory.getSelectedSlot(), 0);
		return T;
	}
