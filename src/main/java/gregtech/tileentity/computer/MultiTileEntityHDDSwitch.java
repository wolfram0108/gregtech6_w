...
public class MultiTileEntityHDDSwitch extends TileEntityBase08DataSwitch {
	...
	@Override @OnlyIn(Dist.CLIENT) public Object getGUIClient2(int aGUIID, Player aPlayer) {return new ContainerClientDefault(aPlayer.getInventory(), this, aGUIID, RES_PATH_GUI + "machines/HDDSwitch.png");}
