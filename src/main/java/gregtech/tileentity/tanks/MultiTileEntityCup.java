...
public class MultiTileEntityCup extends TileEntityBase10FluidContainerSyncSmall implements ITileEntityTapFillable, IMTE_IgnorePlayerCollisionWhenPlacing, IMTE_GetFoodValues, IMTE_OnEaten, IMTE_GetItemUseAction, IMTE_GetMaxItemUseDuration {
	...
	@Override public AABB getCollisionBoundingBoxFromPool() {return box(PX_P[ 5], PX_P[ 0], PX_P[ 5], PX_N[ 5], PX_N[11], PX_N[ 5]);}
	@Override public AABB getSelectedBoundingBoxFromPool () {return box(PX_P[ 5], PX_P[ 0], PX_P[ 5], PX_N[ 5], PX_N[11], PX_N[ 5]);}
