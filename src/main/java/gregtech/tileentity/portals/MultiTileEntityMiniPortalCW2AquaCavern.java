...
public class MultiTileEntityMiniPortalCW2AquaCavern extends MultiTileEntityMiniPortal {
	...
	public void findTargetPortal() {
		...
		if (level != null && isServerSide()) {
			...
			} else if (WD.dimCW2AquaCavern(level)) {
				long tShortestDistance = 128*128;
	...
	public ITexture sCW2Portal = BlockTextureCopied.get(ST.block(MD.CW2, "aqua_cavern_portal", Blocks.NETHER_PORTAL), SIDE_ANY, 0, UNCOLOURED, F, T, T), sCW2PortalFrame = BlockTextureCopied.get(Blocks.MOSSY_COBBLESTONE, SIDE_ANY, 0);
