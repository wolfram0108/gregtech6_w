...
public class MultiTileEntityBedrockDrill extends TileEntityBase10MultiBlockBase implements ITileEntityEnergy, ITileEntityEnergyDataCapacitor, IMultiBlockEnergy, IMultiBlockFluidHandler, IFluidHandler, ITileEntityRunningPossible {
	...
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		...
		aList.add(Chat.GREEN         + LH.get(LH.ENERGY_INPUT) + ": " + Chat.WHITE + LH.tt("1024 to 4096 ") + mEnergyTypeAccepted.getLocalisedChatNameShort() + Chat.WHITE + LH.tt("/t (up to 32768 ") + mEnergyTypeAccepted.getLocalisedChatNameShort() + Chat.WHITE + LH.tt("/t total)"));
	...
	@Override protected IFluidTank getFluidTankFillable(MultiTileEntityMultiBlockPart aPart, byte aSide, FluidStack aFluidToFill) {return FluidsGT.LUBRICANT.contains(FL.regName(aFluidToFill.getFluid())) ? mTank : null;}
	...
	@Override public IFluidTank[] getFluidTanks(MultiTileEntityMultiBlockPart aPart, byte aSide) {return mTank.AS_ARRAY;}
	@Override protected IFluidTank getFluidTankFillable2(byte aSide, FluidStack aFluidToFill) {return FluidsGT.LUBRICANT.contains(FL.regName(aFluidToFill.getFluid())) ? mTank : null;}
