...
public class MultiTileEntityBatteryLU512 extends TileEntityBase08Battery {
	...
	@Override public AABB getCollisionBoundingBoxFromPool() {return box                                            ( PX_P[ 3], PX_P[ 0], PX_P[ 3], PX_N[ 3], PX_N[ 6], PX_N[ 3]);}
	@Override public AABB getSelectedBoundingBoxFromPool () {return box                                            ( PX_P[ 3], PX_P[ 0], PX_P[ 3], PX_N[ 3], PX_N[ 6], PX_N[ 3]);}
