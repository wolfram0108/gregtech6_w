...
public class MultiTileEntityBatteryLU32 extends TileEntityBase08Battery {
	...
	@Override public AABB getCollisionBoundingBoxFromPool() {return box                                            ( PX_P[ 5], PX_P[ 0], PX_P[ 5], PX_N[ 5], PX_N[10], PX_N[ 5]);}
	@Override public AABB getSelectedBoundingBoxFromPool () {return box                                            ( PX_P[ 5], PX_P[ 0], PX_P[ 5], PX_N[ 5], PX_N[10], PX_N[ 5]);}
