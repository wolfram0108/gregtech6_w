...
public class MultiTileEntityBatteryEU8 extends TileEntityBase08Battery {
	...
	@Override public AABB getCollisionBoundingBoxFromPool() {return box(PX_P[ 5], PX_P[ 0], PX_P[ 5], PX_N[ 5], PX_N[ 8], PX_N[ 5]);}
	@Override public AABB getSelectedBoundingBoxFromPool () {return box(PX_P[ 5], PX_P[ 0], PX_P[ 5], PX_N[ 5], PX_N[ 8], PX_N[ 5]);}
