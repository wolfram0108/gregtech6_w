...
public class Compat_Recipes_IndustrialCraft extends CompatMods {
	...
	@Override public void onPostLoad(FMLPostInitializationEvent aInitEvent) {if (MD.IC2C.mLoaded) OUT.println("GT_Mod: Doing IC2-Classic Things."); else OUT.println("GT_Mod: Doing IC2-Exp Things.");
		...
		new GT_BaseCrop("Meat Rose"             , "VintageBeef"             , ST.make(Items.PINK_DYE, 1, 0)                          , ST.array(ST.make(Items.BEEF, 1, 0), ST.make(Items.PORKCHOP, 1, 0), ST.make(Items.CHICKEN, 1, 0), ST.make(Items.COD, 1, 0))                                           , null                                              , 7, 4,  1500, 1, 4, 0, 4, 1, 3, 0, new String[] {"Flower"      , "Food", "Cow", "Fish", "Chicken", "Pig"});
		...
		new GT_BaseCrop("Spidernip"             , "Ms. Muffet"              , ST.make(Items.STRING, 1, 0)                       , ST.array(ST.make(Items.SPIDER_EYE, 1, 0), ST.make(Blocks.COBWEB, 1, 0))                                                                                                  , null                                              , 4, 4,   600, 1, 4, 2, 1, 4, 1, 3, new String[] {"Flower"      , "Toxic", "Silk", "Spider", "Ingredient", "Addictive"});
