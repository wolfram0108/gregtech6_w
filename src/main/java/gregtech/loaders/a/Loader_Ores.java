...
public class Loader_Ores implements Runnable {
	...
	public void run() {
		...
		GT_API.registerBlockLazy(MD.GT.mID, "gt.meta.ore.normal.mud", () -> {PrefixBlock_ o = new PrefixBlock_(MD.GT, "gt.meta.ore.normal.mud"              , OP.oreMud                 , null                                  , BlockTextureCopied.get(Blocks.MUD                , 0), Material.ground,SoundType.GRAVEL , TOOL_shovel   , 0.30F, 0.50F,   0,   0, T,F, OreDictMaterial.MATERIAL_ARRAY); BlocksGT.oreMud = o; return (net.minecraft.world.level.block.Block)o;});
		GT_API.registerBlockLazy(MD.GT.mID, "gt.meta.ore.small.mud", () -> {PrefixBlock_ o = new PrefixBlock_(MD.GT, "gt.meta.ore.small.mud"               , OP.oreSmall               , new Drops_SmallOre(null)              , BlockTextureCopied.get(Blocks.MUD                , 0), Material.ground,SoundType.GRAVEL , TOOL_shovel   , 0.30F, 0.50F,  -1,   0, T,F, OreDictMaterial.MATERIAL_ARRAY); BlocksGT.oreSmallMud = o; return (net.minecraft.world.level.block.Block)o;});
		...
		BlocksGT.stoneToNormalOres.put(new ItemStackContainer(Blocks.MUD, 1, 0), BlocksGT.oreMud     );
		BlocksGT.stoneToBrokenOres.put(new ItemStackContainer(Blocks.MUD, 1, 0), BlocksGT.oreMud     );
		BlocksGT.stoneToSmallOres .put(new ItemStackContainer(Blocks.MUD, 1, 0), BlocksGT.oreSmallMud);
