...
public class Loader_Rocks implements Runnable {
	...
	public void run() {
		...
		int n = 0;
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.granite.black", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.granite.black", MT.STONES.GraniteBlack                                                                                                                , 6.00F, 3.00F,  3, T); BlocksGT.stones[0]=s; BlocksGT.GraniteBlack=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.granite.red", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.granite.red", MT.STONES.GraniteRed                                                                                                                  , 6.00F, 3.00F,  3, T); BlocksGT.stones[1]=s; BlocksGT.GraniteRed=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.basalt", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.basalt", MT.STONES.Basalt                                                                                                                      , 3.00F, 2.00F,  2, F); BlocksGT.stones[2]=s; BlocksGT.Basalt=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.marble", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.marble", MT.STONES.Marble                                                                                                                      , 0.75F, 0.50F,  0, F); BlocksGT.stones[3]=s; BlocksGT.Marble=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.limestone", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.limestone", MT.STONES.Limestone                                                                                                                   , 0.75F, 0.50F,  0, F); BlocksGT.stones[4]=s; BlocksGT.Limestone=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.granite", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.granite", MT.STONES.Granite                                                                                                                     , 2.00F, 1.00F,  1, F); BlocksGT.stones[5]=s; BlocksGT.Granite=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.diorite", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.diorite", MT.STONES.Diorite                                                                                                                     , 0.75F, 0.50F,  0, F); BlocksGT.stones[6]=s; BlocksGT.Diorite=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.andesite", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.andesite", MT.STONES.Andesite                                                                                                                    , 0.75F, 0.50F,  0, F); BlocksGT.stones[7]=s; BlocksGT.Andesite=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.komatiite", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.komatiite", MT.STONES.Komatiite                                                                                                                   , 3.00F, 2.00F,  2, F); BlocksGT.stones[8]=s; BlocksGT.Komatiite=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.greenschist", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.greenschist", MT.STONES.Greenschist                                                                                                                 , 0.75F, 0.50F,  0, F); BlocksGT.stones[9]=s; BlocksGT.SchistGreen=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.blueschist", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.blueschist", MT.STONES.Blueschist                                                                                                                  , 0.75F, 0.50F,  0, F); BlocksGT.stones[10]=s; BlocksGT.SchistBlue=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.kimberlite", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.kimberlite", MT.STONES.Kimberlite                                                                                                                  , 3.00F, 2.00F,  2, F); BlocksGT.stones[11]=s; BlocksGT.Kimberlite=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.quartzite", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.quartzite", MT.STONES.Quartzite                                                                                                                   , 0.75F, 0.50F,  0, F); BlocksGT.stones[12]=s; BlocksGT.Quartzite=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.prismarine.light", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.prismarine.light", MT.PrismarineLight                                                                                                                    , 0.75F, 0.50F,  0, F); BlocksGT.stones[13]=s; BlocksGT.PrismarineLight=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.prismarine.dark", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.prismarine.dark", MT.PrismarineDark                                                                                                                     , 0.75F, 0.50F,  1, F); BlocksGT.stones[14]=s; BlocksGT.PrismarineDark=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.slate", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.slate", MT.STONES.Slate                                                                                                                       , 0.75F, 0.50F,  1, F); BlocksGT.stones[15]=s; BlocksGT.Slate=s; tStoneH[0]=s; return s;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GAPI, "gt.stone.shale", () -> {BlockStonesGT s = new BlockStonesGT("gt.stone.shale", MT.STONES.Shale                                                                                                                       , 0.75F, 0.50F,  0, F); BlocksGT.stones[16]=s; BlocksGT.Shale=s; tStoneH[0]=s; return s;});
