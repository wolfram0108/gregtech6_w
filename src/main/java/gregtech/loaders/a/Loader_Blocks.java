...
public class Loader_Blocks implements Runnable {
	@Override
	public void run() {
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.cfoam", () -> {BlockCFoam b = new BlockCFoam("gt.block.cfoam"); BlocksGT.CFoam = b; VISUALLY_OPAQUE_BLOCKS.add(b); return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.cfoam.fresh", () -> {BlockCFoamFresh b = new BlockCFoamFresh("gt.block.cfoam.fresh"); BlocksGT.CFoamFresh = b; return b;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.diggable", () -> {BlockDiggable b = new BlockDiggable("gt.block.diggable"); BlocksGT.Diggables = b; VISUALLY_OPAQUE_BLOCKS.add(b); return b;});
		if (COMPAT_TC != null) COMPAT_TC.registerThaumcraftAspectsToItem(ST.make(BlocksGT.Diggables, 1, W), F, TC.stack(TC.TERRA, 2));
		
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.grass", () -> {BlockGrass b = new BlockGrass("gt.block.grass"); BlocksGT.Grass = b; VISUALLY_OPAQUE_BLOCKS.add(b); return b;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.paths", () -> {BlockPath b = new BlockPath("gt.block.paths"); BlocksGT.Paths = b; return b;});
		if (COMPAT_TC != null) COMPAT_TC.registerThaumcraftAspectsToItem(ST.make(BlocksGT.Paths, 1, W), F, TC.stack(TC.TERRA, 2));
		
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.rockores", () -> {BlockRockOres b = new BlockRockOres("gt.block.rockores"); BlocksGT.RockOres = b; VISUALLY_OPAQUE_BLOCKS.add(b); return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.crystalores", () -> {BlockCrystalOres b = new BlockCrystalOres("gt.block.crystalores"); BlocksGT.CrystalOres = b; VISUALLY_OPAQUE_BLOCKS.add(b); return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.vanillaores.a", () -> {BlockVanillaOresA b = new BlockVanillaOresA("gt.block.vanillaores.a"); BlocksGT.VanillaOresA = b; VISUALLY_OPAQUE_BLOCKS.add(b); return b;});
		
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.sands", () -> {BlockSands b = new BlockSands("gt.block.sands"); BlocksGT.Sands = b; VISUALLY_OPAQUE_BLOCKS.add(b); return b;});
		if (COMPAT_TC != null) COMPAT_TC.registerThaumcraftAspectsToItem(ST.make(BlocksGT.Sands, 1, W), F, TC.stack(TC.TERRA, 1));
		
		
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.spikes.sharp", () -> {BlockSpikeSharp b = new BlockSpikeSharp("gt.block.spikes.sharp"); BlocksGT.Spikes_Sharp = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.spikes.steel", () -> {BlockSpikeSteel b = new BlockSpikeSteel("gt.block.spikes.steel"); BlocksGT.Spikes_Steel = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.spikes.super", () -> {BlockSpikeSuper b = new BlockSpikeSuper("gt.block.spikes.super"); BlocksGT.Spikes_Super = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.spikes.metal", () -> {BlockSpikeMetal b = new BlockSpikeMetal("gt.block.spikes.metal"); BlocksGT.Spikes_Metal = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.spikes.fancy", () -> {BlockSpikeFancy b = new BlockSpikeFancy("gt.block.spikes.fancy"); BlocksGT.Spikes_Fancy = b; return b;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.bars.wood", () -> {BlockBarsWood b = new BlockBarsWood("gt.block.bars.wood"); BlocksGT.Bars_Wood = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.bars.brass", () -> {BlockBarsBrass b = new BlockBarsBrass("gt.block.bars.brass"); BlocksGT.Bars_Brass = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.bars.steel", () -> {BlockBarsSteel b = new BlockBarsSteel("gt.block.bars.steel"); BlocksGT.Bars_Steel = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.bars.titanium", () -> {BlockBarsTitanium b = new BlockBarsTitanium("gt.block.bars.titanium"); BlocksGT.Bars_Titanium = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.bars.tungstensteel", () -> {BlockBarsTungstenSteel b = new BlockBarsTungstenSteel("gt.block.bars.tungstensteel"); BlocksGT.Bars_TungstenSteel = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.bars.adamantium", () -> {BlockBarsAdamantium b = new BlockBarsAdamantium("gt.block.bars.adamantium"); BlocksGT.Bars_Adamantium = b; return b;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.flower.a", () -> {BlockFlowersA b = new BlockFlowersA("gt.block.flower.a"); BlocksGT.FlowersA = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.flower.b", () -> {BlockFlowersB b = new BlockFlowersB("gt.block.flower.b"); BlocksGT.FlowersB = b; return b;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.lilypad.glowtus", () -> {BlockGlowtus b = new BlockGlowtus("gt.block.lilypad.glowtus"); BlocksGT.Glowtus = b; return b;});
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.bale.grass", () -> {BlockBaleGrass b = new BlockBaleGrass("gt.block.bale.grass"); BlocksGT.BalesGrass = b; VISUALLY_OPAQUE_BLOCKS.add(b); return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.bale.crop", () -> {BlockBaleCrop b = new BlockBaleCrop("gt.block.bale.crop"); BlocksGT.BalesCrop = b; VISUALLY_OPAQUE_BLOCKS.add(b); return b;});
		...
		if (EXPERIMENTS)
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.river.adv", () -> {BlockRiverAdvanced b = new BlockRiverAdvanced("gt.block.river.adv", FL.Soda       .fluid()); BlocksGT.RiverAdvanced = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.river", () -> {BlockRiver b = new BlockRiver("gt.block.river"    , FL.River_Water.fluid()); BlocksGT.River = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.ocean", () -> {BlockOcean b = new BlockOcean("gt.block.ocean"    , FL.Ocean      .fluid()); BlocksGT.Ocean = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.swamp", () -> {net.minecraft.world.level.block.Block b = new BlockSwamp("gt.block.swamp"    , FL.Dirty_Water.fluid()).addEffect(/*hunger*/17, 300, 0).addEffect(/*confusion*/9, 120, 0); BlocksGT.Swamp = b; return b;});
		...
		// СРЕДА НЕФТЕЙ (BUG-120, решение пользователя 2026-08-11, сверх 1:1): во всех нефтях плаваешь, лёгкие —
		// как вода, тяжёлые — вязнешь. Оригинал :165-168 ставил setWeb() только двум тяжёлым (паутина, без
		// всплытия) — заменено шкалой setMedium(гориз., верт., подъём при прыжке); канал и обоснование —
		// BlockBaseFluid.setMedium. Значения вязкости — стартовая калибровка (шкала как у Immersive Petroleum:
		// 0.8 обычные жидкости, 0.4 сырая нефть), судится стендом против живой воды и вашей игрой.
		...
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.fluid.oil.light", () -> {BlockBaseFluid b = new BlockBaseFluid("gt.block.fluid.oil.light"         , FL.Oil_Light       , 1000, MaterialOil.instance).setLighterThanWater().addEffectBreathing(/*poison*/19, 300, 0).addEffectBreathing(/*confusion*/9, 120, 0).addEffectBathing(PotionsGT.ID_FLAMMABLE, 300, 1).addEffectBathing(PotionsGT.ID_SLIPPERY, 300, 1).addEffectBathing(/*blindness*/15, 60, 1).setMedium(0.85, 0.85, 0.14); BlocksGT.OilLight = b; return b;});
		GT_API.registerBlockLazy(gregapi.data.CS.ModIDs.GT, "gt.block.fluid.gas.natural", () -> {BlockBaseFluid b = new BlockBaseFluid("gt.block.fluid.gas.natural"       , FL.Gas_Natural     , 1000, MaterialGas.instance).setLighterThanWater().addEffectBreathing(/*poison*/19, 300, 0).addEffectBreathing(/*confusion*/9, 120, 0); BlocksGT.GasNatural = b; return b;});
