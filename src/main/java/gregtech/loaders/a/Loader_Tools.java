...
public class Loader_Tools implements Runnable {
	...
	public void run() {
		...
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.radiation.boots", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.boots" , "Radiation Hazard Suit Boots"      , "Full Set protects against Radiation"           , "hazard_radiation" , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LlL", "LxL"       , 'L', plate.dat(MT.Pb)); ArmorsGT.HAZMAT_RADIOACTIVE[3]=a; ArmorsGT.HAZMATS_RADIOACTIVE.add(a); return a;});
										 ...
										 GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.universal.head", () -> ArmorsGT.HAZMAT_UNIVERSAL[0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.universal.head"  , "Universal Hazard Suit Mask"       , "Full Set protects against Hazards"             , "hazard_universal" , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, T, T, "AlB", "CqD", "ExF", 'A', ArmorsGT.HAZMAT_BIOCHEMGAS[0], 'B', ArmorsGT.HAZMAT_INSECTS[0], 'C', ArmorsGT.HAZMAT_FROST[0], 'D', ArmorsGT.HAZMAT_HEAT[0], 'E', ArmorsGT.HAZMAT_RADIOACTIVE[0], 'F', Items.CHAINMAIL_HELMET));
										 GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.universal.chest", () -> ArmorsGT.HAZMAT_UNIVERSAL[1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.universal.chest" , "Universal Hazard Suit Shirt"      , "Full Set protects against Hazards"             , "hazard_universal" , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, T, T, "AlB", "CqD", "ExF", 'A', ArmorsGT.HAZMAT_BIOCHEMGAS[1], 'B', ArmorsGT.HAZMAT_INSECTS[1], 'C', ArmorsGT.HAZMAT_FROST[1], 'D', ArmorsGT.HAZMAT_HEAT[1], 'E', ArmorsGT.HAZMAT_RADIOACTIVE[1], 'F', Items.CHAINMAIL_CHESTPLATE));
										 GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.universal.legs", () -> ArmorsGT.HAZMAT_UNIVERSAL[2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.universal.legs"  , "Universal Hazard Suit Pants"      , "Full Set protects against Hazards"             , "hazard_universal" , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, T, T, "AlB", "CqD", "ExF", 'A', ArmorsGT.HAZMAT_BIOCHEMGAS[2], 'B', ArmorsGT.HAZMAT_INSECTS[2], 'C', ArmorsGT.HAZMAT_FROST[2], 'D', ArmorsGT.HAZMAT_HEAT[2], 'E', ArmorsGT.HAZMAT_RADIOACTIVE[2], 'F', Items.CHAINMAIL_LEGGINGS));
										 GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.universal.boots", () -> ArmorsGT.HAZMAT_UNIVERSAL[3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.universal.boots" , "Universal Hazard Suit Boots"      , "Full Set protects against Hazards"             , "hazard_universal" , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, T, T, "AlB", "CqD", "ExF", 'A', ArmorsGT.HAZMAT_BIOCHEMGAS[3], 'B', ArmorsGT.HAZMAT_INSECTS[3], 'C', ArmorsGT.HAZMAT_FROST[3], 'D', ArmorsGT.HAZMAT_HEAT[3], 'E', ArmorsGT.HAZMAT_RADIOACTIVE[3], 'F', Items.CHAINMAIL_BOOTS));
