...
public class Loader_Tools implements Runnable {
	...
	public void run() {
		...
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.insect.head", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.head"     , "Bumblehead"                       , "Full Set protects against any Insects"         , "hazard_insects"   , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RRR", "RGR", "q l", 'R', foil.dat(ANY.Rubber), 'G', Blocks.BLACK_STAINED_GLASS_PANE); ArmorsGT.HAZMAT_INSECTS[0]=a; ArmorsGT.HAZMATS_INSECTS.add(a); return a;});
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.insect.chest", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.chest"    , "Bumbleshirt"                      , "Full Set protects against any Insects"         , "hazard_insects"   , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RqR", "RRR", "RRR", 'R', foil.dat(ANY.Rubber)); ArmorsGT.HAZMAT_INSECTS[1]=a; ArmorsGT.HAZMATS_INSECTS.add(a); return a;});
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.insect.legs", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.legs"     , "Bumblepants"                      , "Full Set protects against any Insects"         , "hazard_insects"   , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RRR", "RqR", "RlR", 'R', foil.dat(ANY.Rubber)); ArmorsGT.HAZMAT_INSECTS[2]=a; ArmorsGT.HAZMATS_INSECTS.add(a); return a;});
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.insect.boots", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.boots"    , "Bumbleboots"                      , "Full Set protects against any Insects"         , "hazard_insects"   , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RlR", "RqR"       , 'R', foil.dat(ANY.Rubber)); ArmorsGT.HAZMAT_INSECTS[3]=a; ArmorsGT.HAZMATS_INSECTS.add(a); return a;});
		
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.frost.head", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.frost.head"      , "Frost Protection Suit Mask"       , "Full Set protects against Cold"                , "hazard_frost"     , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "AAA", "AGA", "q l", 'A', plate.dat(MT.Asbestos), 'G', Blocks.BLACK_STAINED_GLASS_PANE); ArmorsGT.HAZMAT_FROST[0]=a; ArmorsGT.HAZMATS_FROST.add(a); return a;});
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.frost.chest", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.frost.chest"     , "Frost Protection Suit Shirt"      , "Full Set protects against Cold"                , "hazard_frost"     , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "AqA", "AAA", "AAA", 'A', plate.dat(MT.Asbestos)); ArmorsGT.HAZMAT_FROST[1]=a; ArmorsGT.HAZMATS_FROST.add(a); return a;});
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.frost.legs", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.frost.legs"      , "Frost Protection Suit Pants"      , "Full Set protects against Cold"                , "hazard_frost"     , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "AAA", "AqA", "AlA", 'A', plate.dat(MT.Asbestos)); ArmorsGT.HAZMAT_FROST[2]=a; ArmorsGT.HAZMATS_FROST.add(a); return a;});
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.frost.boots", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.frost.boots"     , "Frost Protection Suit Boots"      , "Full Set protects against Cold"                , "hazard_frost"     , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "AlA", "AqA"       , 'A', plate.dat(MT.Asbestos)); ArmorsGT.HAZMAT_FROST[3]=a; ArmorsGT.HAZMATS_FROST.add(a); return a;});
		
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.heat.head", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.heat.head"       , "Heat Protection Suit Mask"        , "Full Set protects against Heat"                , "hazard_heat"      , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, T, F, "FFF", "FGF", "x l", 'F', foil.dat(MT.Al), 'G', Blocks.BLACK_STAINED_GLASS_PANE); ArmorsGT.HAZMAT_HEAT[0]=a; ArmorsGT.HAZMATS_HEAT.add(a); return a;});
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.heat.chest", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.heat.chest"      , "Heat Protection Suit Shirt"       , "Full Set protects against Heat"                , "hazard_heat"      , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, T, F, "FxF", "FFF", "FFF", 'F', foil.dat(MT.Al)); ArmorsGT.HAZMAT_HEAT[1]=a; ArmorsGT.HAZMATS_HEAT.add(a); return a;});
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.heat.legs", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.heat.legs"       , "Heat Protection Suit Pants"       , "Full Set protects against Heat"                , "hazard_heat"      , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, T, F, "FFF", "FxF", "FlF", 'F', foil.dat(MT.Al)); ArmorsGT.HAZMAT_HEAT[2]=a; ArmorsGT.HAZMATS_HEAT.add(a); return a;});
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.heat.boots", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.heat.boots"      , "Heat Protection Suit Boots"       , "Full Set protects against Heat"                , "hazard_heat"      , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, T, F, "FlF", "FxF"       , 'F', foil.dat(MT.Al)); ArmorsGT.HAZMAT_HEAT[3]=a; ArmorsGT.HAZMATS_HEAT.add(a); return a;});
		
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.radiation.head", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.head"  , "Radiation Hazard Suit Mask"       , "Full Set protects against Radiation"           , "hazard_radiation" , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LLL", "LGL", "x l", 'L', plate.dat(MT.Pb), 'G', Blocks.GLASS_PANE); ArmorsGT.HAZMAT_RADIOACTIVE[0]=a; ArmorsGT.HAZMATS_RADIOACTIVE.add(a); return a;});
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.radiation.chest", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.chest" , "Radiation Hazard Suit Shirt"      , "Full Set protects against Radiation"           , "hazard_radiation" , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LxL", "LLL", "LLL", 'L', plate.dat(MT.Pb)); ArmorsGT.HAZMAT_RADIOACTIVE[1]=a; ArmorsGT.HAZMATS_RADIOACTIVE.add(a); return a;});
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.radiation.legs", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.legs"  , "Radiation Hazard Suit Pants"      , "Full Set protects against Radiation"           , "hazard_radiation" , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LLL", "LxL", "LlL", 'L', plate.dat(MT.Pb)); ArmorsGT.HAZMAT_RADIOACTIVE[2]=a; ArmorsGT.HAZMATS_RADIOACTIVE.add(a); return a;});
		GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.radiation.boots", () -> {ItemArmorBase a = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.boots" , "Radiation Hazard Suit Boots"      , "Full Set protects against Radiation"           , "hazard_radiation" , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LlL", "LxL"       , 'L', plate.dat(MT.Pb)); ArmorsGT.HAZMAT_RADIOACTIVE[3]=a; ArmorsGT.HAZMATS_RADIOACTIVE.add(a); return a;});
		
										 GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.biochemgas.head", () -> ArmorsGT.HAZMAT_BIOCHEMGAS[0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.head" , "Biochemical Gas Hazard Suit Mask" , "Full Set protects against Chemicals and Gases" , "hazard_biochemgas", 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RRR", "RGR", "q l", 'R', plate.dat(ANY.Rubber), 'G', Blocks.GLASS_PANE));
										 GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.biochemgas.chest", () -> ArmorsGT.HAZMAT_BIOCHEMGAS[1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.chest", "Biochemical Gas Hazard Suit Shirt", "Full Set protects against Chemicals and Gases" , "hazard_biochemgas", 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RqR", "RRR", "RRR", 'R', plate.dat(ANY.Rubber)));
										 GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.biochemgas.legs", () -> ArmorsGT.HAZMAT_BIOCHEMGAS[2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.legs" , "Biochemical Gas Hazard Suit Pants", "Full Set protects against Chemicals and Gases" , "hazard_biochemgas", 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RRR", "RqR", "RlR", 'R', plate.dat(ANY.Rubber)));
										 GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.biochemgas.boots", () -> ArmorsGT.HAZMAT_BIOCHEMGAS[3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.boots", "Biochemical Gas Hazard Suit Boots", "Full Set protects against Chemicals and Gases" , "hazard_biochemgas", 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RlR", "RqR"       , 'R', plate.dat(ANY.Rubber)));
										 GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.universal.head", () -> ArmorsGT.HAZMAT_UNIVERSAL[0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.universal.head"  , "Universal Hazard Suit Mask"       , "Full Set protects against Hazards"             , "hazard_universal" , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, T, T, "AlB", "CqD", "ExF", 'A', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_BIOCHEMGAS[0], 1, 0), 'B', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_INSECTS[0], 1, 0), 'C', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_FROST[0], 1, 0), 'D', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_HEAT[0], 1, 0), 'E', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_RADIOACTIVE[0], 1, 0), 'F', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(Items.CHAINMAIL_HELMET, 1, 0)));
										 GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.universal.chest", () -> ArmorsGT.HAZMAT_UNIVERSAL[1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.universal.chest" , "Universal Hazard Suit Shirt"      , "Full Set protects against Hazards"             , "hazard_universal" , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, T, T, "AlB", "CqD", "ExF", 'A', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_BIOCHEMGAS[1], 1, 0), 'B', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_INSECTS[1], 1, 0), 'C', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_FROST[1], 1, 0), 'D', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_HEAT[1], 1, 0), 'E', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_RADIOACTIVE[1], 1, 0), 'F', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(Items.CHAINMAIL_CHESTPLATE, 1, 0)));
										 GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.universal.legs", () -> ArmorsGT.HAZMAT_UNIVERSAL[2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.universal.legs"  , "Universal Hazard Suit Pants"      , "Full Set protects against Hazards"             , "hazard_universal" , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, T, T, "AlB", "CqD", "ExF", 'A', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_BIOCHEMGAS[2], 1, 0), 'B', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_INSECTS[2], 1, 0), 'C', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_FROST[2], 1, 0), 'D', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_HEAT[2], 1, 0), 'E', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_RADIOACTIVE[2], 1, 0), 'F', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(Items.CHAINMAIL_LEGGINGS, 1, 0)));
										 GT_API.registerItemLazy(MD.GT.mID, "gt.armor.hazmat.universal.boots", () -> ArmorsGT.HAZMAT_UNIVERSAL[3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.universal.boots" , "Universal Hazard Suit Boots"      , "Full Set protects against Hazards"             , "hazard_universal" , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, T, T, "AlB", "CqD", "ExF", 'A', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_BIOCHEMGAS[3], 1, 0), 'B', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_INSECTS[3], 1, 0), 'C', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_FROST[3], 1, 0), 'D', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_HEAT[3], 1, 0), 'E', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(ArmorsGT.HAZMAT_RADIOACTIVE[3], 1, 0), 'F', (java.util.function.Supplier<net.minecraft.world.item.ItemStack>)() -> ST.make(Items.CHAINMAIL_BOOTS, 1, 0)));
...
//      ToolsGT.add(ToolIDs.sMetaTool.addTool(ToolIDs.SICKLE                    , "Sickle"                          , "Harvests Crops more efficiently"                     , new GT_Tool_Sickle()                                           .setMaterialAmount(3*U                                       ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GRANUM        , 2)                                ), TOOL_sickle);
		...
		toolHeadPickaxe            .addListener(new OreProcessing_Tool(SCOOP                 , tCategory + "Scoop"               ,F,F,0,0, null, new String[][] {{"SVS", "SSS", "xSh"}}                                              , null                                                                                , null         , null, null, Blocks.WHITE_WOOL                       , null, new And(ANTIMATTER.NOT, MT.Wood.NOT)));
				...
				if (tTool != null) {
					if (mToolRecipes != null && mToolRecipes.length > 0) {
						for (int i = 0; i < mToolRecipes.length; i++) if (mToolRecipes[i] != null && mToolRecipes[i].length > 0 && (mCategoryName == null || ConfigsGT.RECIPES.get(mCategoryName + ".toolrecipes."+i, aEvent.mMaterial.mNameInternal, T))) {
								...
								, 'R', aEvent.mMaterial==MT.Stone?ST.make(Blocks.STONE, 1, 0):stone.dat(aEvent.mMaterial)
