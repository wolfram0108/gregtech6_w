...
public class Loader_Worldgen implements Runnable {
	...
	public void run() {
		...
		// [GT6-DUNGEONPROBE-LIVETEST] ВРЕМЕННО Probability 100→5 (данж на ~каждом 5-м якоре, сетка якорей 176 блоков)
		// для живого теста игрока: грегов конфиг хранит дефолт в имени ключа (Probability_5) — подхватится сам.
		// ВЕРНУТЬ 100 при уборке захода #39.
		new WorldgenDungeonGT("overworld.structure.dungeon.large", T, 5, 3, 7, 20, 20, 6, T, F, F, T, T, T, T, T, GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_TFC);
