...
public class Loader_Loot implements Runnable {
	@Override
	public void run() {
		// 1.7.10's chest-loot API is reproduced centrally in a shim buffer that feeds neo's data-driven tables.
		// This file is a 1:1 port of the original.
		...
		addLoot("gt.misc",  13, 1, 1, ST.make(Items.MUSIC_DISC_13     , 1, 0));
		addLoot("gt.misc",  13, 1, 1, ST.make(Items.MUSIC_DISC_CAT    , 1, 0));
		addLoot("gt.misc",  13, 1, 1, ST.make(Items.MUSIC_DISC_BLOCKS , 1, 0));
		addLoot("gt.misc",  13, 1, 1, ST.make(Items.MUSIC_DISC_CHIRP  , 1, 0));
		addLoot("gt.misc",  13, 1, 1, ST.make(Items.MUSIC_DISC_FAR    , 1, 0));
		addLoot("gt.misc",  13, 1, 1, ST.make(Items.MUSIC_DISC_MALL   , 1, 0));
		addLoot("gt.misc",  13, 1, 1, ST.make(Items.MUSIC_DISC_MELLOHI, 1, 0));
		addLoot("gt.misc",  13, 1, 1, ST.make(Items.MUSIC_DISC_STAL   , 1, 0));
		addLoot("gt.misc",  13, 1, 1, ST.make(Items.MUSIC_DISC_STRAD  , 1, 0));
		addLoot("gt.misc",  13, 1, 1, ST.make(Items.MUSIC_DISC_WARD   , 1, 0));
		addLoot("gt.misc",  13, 1, 1, ST.make(Items.MUSIC_DISC_11     , 1, 0));
		addLoot("gt.misc",  13, 1, 1, ST.make(Items.MUSIC_DISC_WAIT   , 1, 0));
