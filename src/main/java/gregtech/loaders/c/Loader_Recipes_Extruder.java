...
public class Loader_Recipes_Extruder implements Runnable {
	...
	public void run() {
		...
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_Extruder_Plate       .get(0), OP.plate.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_Extruder_Plate_Curved.get(0), OP.plateCurved.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_Extruder_Rod         .get(0), OP.stick.mat(MT.Stone, 2));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_Extruder_Rod_Long    .get(0), OP.stickLong.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,   8, ST.make(Blocks.STONE, 1, 0), IL.Shape_Extruder_Bolt        .get(0), OP.bolt.mat(MT.Stone, 8));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_Extruder_Ingot       .get(0), ST.make(Blocks.STONE_BRICKS, 1, 0));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_Extruder_Block       .get(0), ST.make(Blocks.STONE, 1, 0));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_Extruder_Shovel      .get(0), OP.toolHeadRawShovel.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  64, ST.make(Blocks.STONE, 2, 0), IL.Shape_Extruder_Sword       .get(0), OP.toolHeadRawSword.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  64, ST.make(Blocks.STONE, 2, 0), IL.Shape_Extruder_Hoe         .get(0), OP.toolHeadRawHoe.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  96, ST.make(Blocks.STONE, 3, 0), IL.Shape_Extruder_Pickaxe     .get(0), OP.toolHeadRawPickaxe.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  96, ST.make(Blocks.STONE, 3, 0), IL.Shape_Extruder_Axe         .get(0), OP.toolHeadRawAxe.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16, 128, ST.make(Blocks.STONE, 4, 0), IL.Shape_Extruder_Gear        .get(0), OP.gearGt.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_Extruder_Gear_Small  .get(0), OP.gearGtSmall.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16, 192, ST.make(Blocks.STONE, 6, 0), IL.Shape_Extruder_Hammer      .get(0), OP.toolHeadHammer.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_SimpleEx_Plate       .get(0), OP.plate.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_SimpleEx_Plate_Curved.get(0), OP.plateCurved.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_SimpleEx_Rod         .get(0), OP.stick.mat(MT.Stone, 2));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_SimpleEx_Rod_Long    .get(0), OP.stickLong.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,   8, ST.make(Blocks.STONE, 1, 0), IL.Shape_SimpleEx_Bolt        .get(0), OP.bolt.mat(MT.Stone, 8));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_SimpleEx_Ingot       .get(0), ST.make(Blocks.STONE_BRICKS, 1, 0));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_SimpleEx_Block       .get(0), ST.make(Blocks.STONE, 1, 0));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_SimpleEx_Shovel      .get(0), OP.toolHeadRawShovel.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  64, ST.make(Blocks.STONE, 2, 0), IL.Shape_SimpleEx_Sword       .get(0), OP.toolHeadRawSword.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  64, ST.make(Blocks.STONE, 2, 0), IL.Shape_SimpleEx_Hoe         .get(0), OP.toolHeadRawHoe.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  96, ST.make(Blocks.STONE, 3, 0), IL.Shape_SimpleEx_Pickaxe     .get(0), OP.toolHeadRawPickaxe.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  96, ST.make(Blocks.STONE, 3, 0), IL.Shape_SimpleEx_Axe         .get(0), OP.toolHeadRawAxe.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16, 128, ST.make(Blocks.STONE, 4, 0), IL.Shape_SimpleEx_Gear        .get(0), OP.gearGt.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, 0), IL.Shape_SimpleEx_Gear_Small  .get(0), OP.gearGtSmall.mat(MT.Stone, 1));
		RM.Extruder.addRecipe2(T, F, F, F, T, 16, 192, ST.make(Blocks.STONE, 6, 0), IL.Shape_SimpleEx_Hammer      .get(0), OP.toolHeadHammer.mat(MT.Stone, 1));
