...
public abstract class TileEntityBase10MultiBlockBase extends TileEntityBase09FacingSingle implements ITileEntityMultiBlockController {
	...
	public void readFromNBT2(CompoundTag aNBT) {
		...
		if (aNBT.contains(NBT_STATE+".str")) mStructureOkay = aNBT.getBoolean(NBT_STATE+".str").orElse(false);
	...
	@Override public    IFluidTank[] getFluidTanks          (MultiTileEntityMultiBlockPart aPart, byte aSide) {return getFluidTanks2(aSide);}
