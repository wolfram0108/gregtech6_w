...
public interface ITexture {
	...
	public static class Util {
		...
		public static void prepareRenderXPos(short[] aRGBa, boolean aAllowAlpha, boolean aUseConstantBrightness, RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ, int aBrightness) {
			...
			Tesselator.instance.setColorRGBA((int)(UT.Code.bind8(aRGBa[0]) * 0.6F), (int)(UT.Code.bind8(aRGBa[1]) * 0.6F), (int)(UT.Code.bind8(aRGBa[2]) * 0.6F), aAllowAlpha?UT.Code.bind8(aRGBa[3]):255);
			Tesselator.instance.setBrightness(aBrightness);
		...
		public static void prepareRenderYPos(short[] aRGBa, boolean aAllowAlpha, boolean aUseConstantBrightness, RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ, int aBrightness) {
			if (aRGBa == null) aRGBa = UNCOLOURED;
			Tesselator.instance.setColorRGBA((int)(UT.Code.bind8(aRGBa[0]) * 1.0F), (int)(UT.Code.bind8(aRGBa[1]) * 1.0F), (int)(UT.Code.bind8(aRGBa[2]) * 1.0F), aAllowAlpha?UT.Code.bind8(aRGBa[3]):255);
			Tesselator.instance.setBrightness(aBrightness);
		...
		public static void prepareRenderYNeg(short[] aRGBa, boolean aAllowAlpha, boolean aUseConstantBrightness, RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ, int aBrightness) {
			if (aRGBa == null) aRGBa = UNCOLOURED;
			Tesselator.instance.setColorRGBA((int)(UT.Code.bind8(aRGBa[0]) * 0.5F), (int)(UT.Code.bind8(aRGBa[1]) * 0.5F), (int)(UT.Code.bind8(aRGBa[2]) * 0.5F), aAllowAlpha?UT.Code.bind8(aRGBa[3]):255);
			Tesselator.instance.setBrightness(aBrightness);
		...
		public static void prepareRenderZPos(short[] aRGBa, boolean aAllowAlpha, boolean aUseConstantBrightness, RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ, int aBrightness) {
			if (aRGBa == null) aRGBa = UNCOLOURED;
			Tesselator.instance.setColorRGBA((int)(UT.Code.bind8(aRGBa[0]) * 0.8F), (int)(UT.Code.bind8(aRGBa[1]) * 0.8F), (int)(UT.Code.bind8(aRGBa[2]) * 0.8F), aAllowAlpha?UT.Code.bind8(aRGBa[3]):255);
			Tesselator.instance.setBrightness(aBrightness);
		...
		//  double tMinZ1 = aIcon.getInterpolatedV(aRenderer.renderMaxZ * 16.0);
			...
			if (aRenderer.enableAO) {
				Tesselator.instance.setColorOpaque_F(aRenderer.colorRedTopLeft, aRenderer.colorGreenTopLeft, aRenderer.colorBlueTopLeft);
				Tesselator.instance.setBrightness(aRenderer.brightnessTopLeft);
				Tesselator.instance.addVertexWithUV(tMinX3, tMinY3, tMaxZ3, tMinX2, tMinZ2);
				Tesselator.instance.setColorOpaque_F(aRenderer.colorRedBottomLeft, aRenderer.colorGreenBottomLeft, aRenderer.colorBlueBottomLeft);
				Tesselator.instance.setBrightness(aRenderer.brightnessBottomLeft);
				Tesselator.instance.addVertexWithUV(tMinX3, tMinY3, tMinZ3, tMinX1, tMaxZ1);
				Tesselator.instance.setColorOpaque_F(aRenderer.colorRedBottomRight, aRenderer.colorGreenBottomRight, aRenderer.colorBlueBottomRight);
				Tesselator.instance.setBrightness(aRenderer.brightnessBottomRight);
				Tesselator.instance.addVertexWithUV(tMaxX3, tMinY3, tMinZ3, tMaxX2, tMaxZ2);
				Tesselator.instance.setColorOpaque_F(aRenderer.colorRedTopRight, aRenderer.colorGreenTopRight, aRenderer.colorBlueTopRight);
				Tesselator.instance.setBrightness(aRenderer.brightnessTopRight);
				Tesselator.instance.addVertexWithUV(tMaxX3, tMinY3, tMaxZ3, tMaxX1, tMinZ1);
			} else {
				Tesselator.instance.addVertexWithUV(tMinX3, tMinY3, tMaxZ3, tMinX2, tMinZ2);
				Tesselator.instance.addVertexWithUV(tMinX3, tMinY3, tMinZ3, tMinX1, tMaxZ1);
				Tesselator.instance.addVertexWithUV(tMaxX3, tMinY3, tMinZ3, tMaxX2, tMaxZ2);
