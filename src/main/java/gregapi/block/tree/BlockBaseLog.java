...
public abstract class BlockBaseLog extends BlockBaseTree {
	...
	@Override public float getBlockHardness(Level aWorld, int aX, int aY, int aZ) {return WD.hardness(Blocks.OAK_LOG, aWorld, aX, aY, aZ);}
	...
	@Override public ResourceLocation getIcon(int aSide, int aMeta) {return mIcons[2*(aMeta&PILLAR_DATA)+(PILLAR_TO_AXIS[aMeta][aSide]?0:1)].getIcon(0);}
