...
public class MT {
	...
	H2O                     = lquddcmp      ( 9800, "Water"                                         , 100, 100, 255, 255, UNRECYCLABLE, FOOD, MELTING)                                                                                                              .uumMcfg( 0, H              , 2*U, O                , 1*U)                                                                                                  .aspects(TC.AQUA, 2                 ).heat(CS.C  , CS.C+100).setDensity(1.0000).liquid(FL.Water, 1000), Water = H2O,
	...
	Lava                    = lqud          ( 9810, "Lava"                  , SET_STONE             , 255,  64,   0, 255, MELTING, GLOWING, LIGHTING)                                                                                                                                                                                                                                                                           .heat(1300, 4000).liquid(FL.Lava, 1000, U*9),
...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     , SOFT).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                            ,
	...
	public static class TECH {
		...
		static void init() {
			...
			Plastic                 .addEnchantmentForDamage(Enchantments.KNOCKBACK, 1).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 1);
			Bakelite                .addEnchantmentForDamage(Enchantments.KNOCKBACK, 1).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 1);
			Teflon                  .addEnchantmentForDamage(Enchantments.KNOCKBACK, 1).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 1);
			PVC                     .addEnchantmentForDamage(Enchantments.KNOCKBACK, 2).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 2);
			Polycarbonate           .addEnchantmentForDamage(Enchantments.KNOCKBACK, 2).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 2);          
			Rubber                  .addEnchantmentForDamage(Enchantments.KNOCKBACK, 2).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 2);
			Kalendrite              .addEnchantmentForDamage(Enchantments.KNOCKBACK, 2).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 2);
			InfusedAir              .addEnchantmentForDamage(Enchantments.KNOCKBACK, 2).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 2);
			Blitz                   .addEnchantmentForDamage(Enchantments.KNOCKBACK, 3).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 3);
			Gravitite               .addEnchantmentForDamage(Enchantments.KNOCKBACK, 3).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 3);
			DarkIron                .addEnchantmentForDamage(Enchantments.KNOCKBACK, 3).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 3);
			Tartarite               .addEnchantmentForDamage(Enchantments.KNOCKBACK, 3).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 3);
			DarkMatter              .addEnchantmentForDamage(Enchantments.KNOCKBACK, 3).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 3);
			RedMeteor               .addEnchantmentForDamage(Enchantments.KNOCKBACK, 3).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS, 3);
			Infinity                .addEnchantmentForDamage(Enchantments.KNOCKBACK,10).addEnchantmentForRanged(Enchantments.PUNCH_ARROWS,10);
			
			Skyroot                 .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 1).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 1).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 2).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 1).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 1);
			IronWood                .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 1).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 1).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 2).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 1).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 1);
			Steeleaf                .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 2).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 2).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 2).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 2);
			Fireleaf                .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			Efrine                  .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 2).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 2).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 2).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 2);
			Soularium               .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 2).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 2).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 2).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 2);
			Midasium                .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 2).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 2).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 2).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 2);
			Mithril                 .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			ElvenQuartz             .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			Vinteum                 .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 1).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 1).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 2).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 1).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 1);
			Manasteel               .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 2).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 2).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 2).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 2);
			Thaumium                .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 2).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 2).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 2).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 2);
			DarkThaumium            .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 2).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 2).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 2).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 2);
			VoidMetal               .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			InfusedWater            .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			Eximite                 .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			DarkMatter              .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			RedMatter               .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			Chimerite               .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			Jade                    .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			Sugilite                .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			EnderAmethyst           .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			Continuum               .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 3).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 3).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 3);
			Basalz                  .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 4).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 4).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 8).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 4).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 4);
			Carminite               .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 4).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 4).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 8).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 4).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 4);
			Ma                      .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 4).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 4).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 8).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 4).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 4);
			Haderoth                .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 4).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 4).addEnchantmentForAmmo(Enchantments.MOB_LOOTING, 8).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 4).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 4);
			VibraniumSteel          .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 5).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 5).addEnchantmentForAmmo(Enchantments.MOB_LOOTING,10).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 5).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 5);
			Vibramantium            .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 5).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 5).addEnchantmentForAmmo(Enchantments.MOB_LOOTING,10).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 5).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 5);
			Vb                      .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE, 5).addEnchantmentForWeapons(Enchantments.MOB_LOOTING, 5).addEnchantmentForAmmo(Enchantments.MOB_LOOTING,10).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 5).addEnchantmentForFishing(Enchantments.FISHING_LUCK, 5);
			Infinity                .addEnchantmentForTools(Enchantments.BLOCK_FORTUNE,10).addEnchantmentForWeapons(Enchantments.MOB_LOOTING,10).addEnchantmentForAmmo(Enchantments.MOB_LOOTING,20).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS,10).addEnchantmentForFishing(Enchantments.FISHING_LUCK,10);
			
			Ad                      .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			Adamantine              .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			Force                   .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			Amber                   .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			AmberGolden             .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			AmberDominican          .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			Ambrosium               .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			ManaQuartz              .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			Blizz                   .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			Frezarite               .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			Inolashite              .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			Sanguinite              .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			NetherStar              .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			InfusedOrder            .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			InfusedBalance          .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			NiflheimPower           .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			Vibramantium            .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1);
			Infinity                .addEnchantmentForTools(Enchantments.SILK_TOUCH,10);
			
			EnderPearl              .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 1);;
			Enderium                .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 2);;
			Endium                  .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3);;
			SpectreIron             .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1).addEnchantmentForRanged(Enchantments.INFINITY_ARROWS, 3);;
			
			Flint                   .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 1).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 1);
			Netherrack              .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 1).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 1);
			Obsidian                .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 1).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 1);
			STONES.Gneiss           .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 2);
			NetherBrick             .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 2);
			PO4                     .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 2);
			Phosphorite             .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 2);
			Phosphorus              .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 2);
			PhosphorusBlue          .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 2);
			PhosphorusRed           .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 2);
			PhosphorusWhite         .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 2);
			ObsidianSteel           .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 2);
			Ignatius                .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 2);
			Sunstone                .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Prometheum              .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Octine                  .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Kreknorite              .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Firestone               .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Fireleaf                .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			FierySteel              .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			MeteoflameSteel         .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			MeteoflameBlackSteel    .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			MeteoflameBlueSteel     .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			MeteoflameRedSteel      .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			FlamascusSteel          .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Pyrotheum               .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Blaze                   .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			InfusedFire             .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Vulcanite               .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Amordrine               .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			MuspelheimPower         .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			RedMatter               .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Netherite               .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			NetherizedDiamond       .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Infinity                .addEnchantmentForDamage(Enchantments.FIRE_ASPECT,10).addEnchantmentForRanged(Enchantments.FLAMING_ARROWS,10).addEnchantmentForTools(Enchantments.FIRE_ASPECT,10);
			
			Skyroot                 .addEnchantmentForDamage(Enchantments.SMITE, 2);
			Hepatizon               .addEnchantmentForDamage(Enchantments.SMITE, 2);
			BlackBronze             .addEnchantmentForDamage(Enchantments.SMITE, 2);
			RedSteel                .addEnchantmentForDamage(Enchantments.SMITE, 3);
			MeteoricRedSteel        .addEnchantmentForDamage(Enchantments.SMITE, 3);
			MeteoflameRedSteel      .addEnchantmentForDamage(Enchantments.SMITE, 3);
			Au                      .addEnchantmentForDamage(Enchantments.SMITE, 3);
			TitaniumGold            .addEnchantmentForDamage(Enchantments.SMITE, 3);
			Electrum                .addEnchantmentForDamage(Enchantments.SMITE, 3);
			GildedIron              .addEnchantmentForDamage(Enchantments.SMITE, 3);
			STONES.Holystone        .addEnchantmentForDamage(Enchantments.SMITE, 3);
			RoseGold                .addEnchantmentForDamage(Enchantments.SMITE, 4);
			EnergeticAlloy          .addEnchantmentForDamage(Enchantments.SMITE, 4);
			SpectreIron             .addEnchantmentForDamage(Enchantments.SMITE, 5);
			VibrantAlloy            .addEnchantmentForDamage(Enchantments.SMITE, 5);
			AmberGolden             .addEnchantmentForDamage(Enchantments.SMITE, 5);
			Zanite                  .addEnchantmentForDamage(Enchantments.SMITE, 5);
			Mauftrium               .addEnchantmentForDamage(Enchantments.SMITE, 5);
			Carmot                  .addEnchantmentForDamage(Enchantments.SMITE, 5);
			Pt                      .addEnchantmentForDamage(Enchantments.SMITE, 5);
			Mithril                 .addEnchantmentForDamage(Enchantments.SMITE, 5);
			InfusedVis              .addEnchantmentForDamage(Enchantments.SMITE, 5);
			Infinity                .addEnchantmentForDamage(Enchantments.SMITE,10);
			
			Pb                      .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 2);
			Ni                      .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 2);
			Constantan              .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 2);
			Nichrome                .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 2);
			Invar                   .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 3);
			Sb                      .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 3);
			Aredrite                .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 3);
			BatteryAlloy            .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 4);
			Bi                      .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 4);
			Orichalcum              .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 4);
			BismuthBronze           .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 4);
			InfusedEarth            .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 5);
			Celenegil               .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS, 5);
			Infinity                .addEnchantmentForDamage(Enchantments.BANE_OF_ARTHROPODS,10);
			
			Fe                      .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 1);
			IronMagnetic            .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 1);
			IronWood                .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 1);
			Ice                     .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 1);
			Glass                   .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 1);
			Bronze                  .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 1);
			ArsenicCopper           .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 1);
			ArsenicBronze           .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 1);
			GildedIron              .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 1);
			PulsatingIron           .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 1);
			ConductiveIron          .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 1);
			RedstoneAlloy           .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 1);
			ElectricalSteel         .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			Brass                   .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			CobaltBrass             .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			HSLA                    .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			Steel                   .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			SteelMagnetic           .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			SteelGalvanized         .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			Syrmorite               .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			WroughtIron             .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			PigIron                 .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			Meteorite               .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			FierySteel              .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			FrozenIron              .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			MeteoricIron            .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 2);
			MeteoricSteel           .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			MeteoflameSteel         .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			Steeleaf                .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			Fireleaf                .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			VanadiumSteel           .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			StainlessSteel          .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			Knightmetal             .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			DeepIron                .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			ShadowIron              .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			BlackSteel              .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			MeteoricBlackSteel      .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			MeteoflameBlackSteel    .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			RedSteel                .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			MeteoricRedSteel        .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			MeteoflameRedSteel      .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			BlueSteel               .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			MeteoricBlueSteel       .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			MeteoflameBlueSteel     .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			Ti                      .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			TitaniumGold            .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			TungstenAlloy           .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 3);
			TungstenSteel           .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 4);
			NetherizedDiamond       .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 4);
			HSSG                    .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 4);
			HSSE                    .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 4);
			HSSS                    .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 4);
			ShadowSteel             .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 4);
			Zanite                  .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 4);
			DamascusSteel           .addEnchantmentForDamage(Enchantments.SHARPNESS, 5).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 5);
			FlamascusSteel          .addEnchantmentForDamage(Enchantments.SHARPNESS, 5).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 5);
			Elvorium                .addEnchantmentForDamage(Enchantments.SHARPNESS, 5).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 5);
			InfusedEntropy          .addEnchantmentForDamage(Enchantments.SHARPNESS, 5).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 5);
			Ke                      .addEnchantmentForDamage(Enchantments.SHARPNESS, 6).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 6);
			Ad                      .addEnchantmentForDamage(Enchantments.SHARPNESS, 7).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 7);
			Trinitanium             .addEnchantmentForDamage(Enchantments.SHARPNESS, 7).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 7);
			Trinaquadalloy          .addEnchantmentForDamage(Enchantments.SHARPNESS, 8).addEnchantmentForRanged(Enchantments.POWER_ARROWS, 8);
			Infinity                .addEnchantmentForDamage(Enchantments.SHARPNESS,10).addEnchantmentForRanged(Enchantments.POWER_ARROWS,10);
			
			
			Oureclase               .addEnchantmentForArmors(Enchantments.RESPIRATION, 3);
			InfusedAir              .addEnchantmentForArmors(Enchantments.RESPIRATION, 3);
			Infinity                .addEnchantmentForArmors(Enchantments.RESPIRATION,10);
			
			Atl                     .addEnchantmentForArmors(Enchantments.FALL_PROTECTION, 4);
			InfusedFire             .addEnchantmentForArmors(Enchantments.FALL_PROTECTION, 4);
			Infinity                .addEnchantmentForArmors(Enchantments.FALL_PROTECTION,10);
			
			Steeleaf                .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION, 2);
			Fireleaf                .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION, 2);
			Knightmetal             .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION, 1);
			Celenegil               .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION, 4);
			InfusedEarth            .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION, 4);
			InfusedVis              .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION, 4);
			InfusedBalance          .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION, 4);
			Tartarite               .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION, 5);
			Adamantine              .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION, 5);
			DarkMatter              .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION, 5);
			VibraniumSilver         .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION, 6);
			VibraniumSteel          .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION, 8);
			Vibramantium            .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION,10);
			Vb                      .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION,10);
			Ad                      .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION,10);
			Infinity                .addEnchantmentForArmors(Enchantments.ALL_DAMAGE_PROTECTION,10);
			
			Aredrite                .addEnchantmentForArmors(Enchantments.FIRE_PROTECTION, 3);
			Efrine                  .addEnchantmentForArmors(Enchantments.FIRE_PROTECTION, 3);
			Netherite               .addEnchantmentForArmors(Enchantments.FIRE_PROTECTION, 3);
			NetherizedDiamond       .addEnchantmentForArmors(Enchantments.FIRE_PROTECTION, 5);
			
			Vyroxeres               .addEnchantmentForArmors(Enchantments.THORNS, 3);
			InfusedEntropy          .addEnchantmentForArmors(Enchantments.THORNS, 3);
			Infinity                .addEnchantmentForArmors(Enchantments.THORNS,10);
			
			InfusedWater            .addEnchantmentForArmors(Enchantments.AQUA_AFFINITY, 1);
			IronWood                .addEnchantmentForArmors(Enchantments.AQUA_AFFINITY, 1);
			Ceruclase               .addEnchantmentForArmors(Enchantments.AQUA_AFFINITY, 1);
			Inolashite              .addEnchantmentForArmors(Enchantments.AQUA_AFFINITY, 1);
			Infinity                .addEnchantmentForArmors(Enchantments.AQUA_AFFINITY,10);
			
			InfusedOrder            .addEnchantmentForArmors(Enchantments.PROJECTILE_PROTECTION, 4);
			Infinity                .addEnchantmentForArmors(Enchantments.PROJECTILE_PROTECTION,10);
			
			Obsidian                .addEnchantmentForArmors(Enchantments.BLAST_PROTECTION, 3);
			InfusedDull             .addEnchantmentForArmors(Enchantments.BLAST_PROTECTION, 4);
			...
			Electrum                .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 3);
			BlackBronze             .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 2);
			BlackSteel              .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 2);
			MeteoricBlackSteel      .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 2);
			MeteoflameBlackSteel    .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 2);
			RedSteel                .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 1);
			MeteoricRedSteel        .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 1);
			MeteoflameRedSteel      .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 1);
			BlueSteel               .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 3);
			MeteoricBlueSteel       .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 3);
			MeteoflameBlueSteel     .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 3);
			ElectrumFlux            .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 3);
			Meutoite                .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 3);
			SterlingSilver          .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 4);
			AstralSilver            .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 5);
			Desichalkos             .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 6);
			VibraniumSilver         .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 10);
			Infinity                .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.INSTANCE, 10);
			KCl                     .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			KIO3                    .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 3);
			NaCl                    .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 3);
			As                      .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 3);
			Cu                      .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 4);
			Brass                   .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			CobaltBrass             .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			BismuthBronze           .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			RoseGold                .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			SterlingSilver          .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			Bronze                  .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			BlackBronze             .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			BlackSteel              .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			MeteoricBlackSteel      .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			MeteoflameBlackSteel    .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			RedSteel                .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			MeteoricRedSteel        .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			MeteoflameRedSteel      .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			BlueSteel               .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			MeteoricBlueSteel       .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			MeteoflameBlueSteel     .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 2);
			Constantan              .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 3);
			AnnealedCopper          .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 4);
			Hepatizon               .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 5);
			Vyroxeres               .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 5);
			ArsenicCopper           .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 5);
			ArsenicBronze           .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 7);
			Infinity                .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.INSTANCE, 10);
			Ir                      .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 6);
			Osmiridium              .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 6);
			HSSS                    .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 6);
			Moonstone               .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 5);
			Ag                      .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 4);
			Electrum                .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 3);
			BlackBronze             .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 2);
			BlackSteel              .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 2);
			MeteoricBlackSteel      .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 2);
			MeteoflameBlackSteel    .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 2);
			RedSteel                .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 1);
			MeteoricRedSteel        .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 1);
			MeteoflameRedSteel      .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 1);
			BlueSteel               .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 3);
			MeteoricBlueSteel       .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 3);
			MeteoflameBlueSteel     .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 3);
			SterlingSilver          .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 4);
			AstralSilver            .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 5);
			VibraniumSilver         .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 10);
			Craponite               .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 10);
			Tc                      .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 10);
			Infinity                .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 10);
			DiamondPink             .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.INSTANCE, 10);
			Cyanite                 .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 1);
			Yellorium               .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 1);
			Blutonium               .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 2);
			Ludicrite               .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 4);
			Pu                      .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 1);
			U_235                   .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 2);
			Co_60                   .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 2);
			Pu_241                  .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 3);
			Pu_243                  .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 3);
			At                      .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 4);
			Am_241                  .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 4);
			Nq_528                  .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 4);
			Nq_522                  .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 5);
			CosmicNeutronium        .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.INSTANCE, 10);
