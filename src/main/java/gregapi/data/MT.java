...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     , SOFT).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                            ,
	...
	public static class TECH {
		...
		static void init() {
			...
			Plastic                 .addEnchantmentForDamage(Enchantments.KNOCKBACK, 1).addEnchantmentForRanged(Enchantments.PUNCH, 1);
			Bakelite                .addEnchantmentForDamage(Enchantments.KNOCKBACK, 1).addEnchantmentForRanged(Enchantments.PUNCH, 1);
			Teflon                  .addEnchantmentForDamage(Enchantments.KNOCKBACK, 1).addEnchantmentForRanged(Enchantments.PUNCH, 1);
			PVC                     .addEnchantmentForDamage(Enchantments.KNOCKBACK, 2).addEnchantmentForRanged(Enchantments.PUNCH, 2);
			Polycarbonate           .addEnchantmentForDamage(Enchantments.KNOCKBACK, 2).addEnchantmentForRanged(Enchantments.PUNCH, 2);          
			Rubber                  .addEnchantmentForDamage(Enchantments.KNOCKBACK, 2).addEnchantmentForRanged(Enchantments.PUNCH, 2);
			Kalendrite              .addEnchantmentForDamage(Enchantments.KNOCKBACK, 2).addEnchantmentForRanged(Enchantments.PUNCH, 2);
			InfusedAir              .addEnchantmentForDamage(Enchantments.KNOCKBACK, 2).addEnchantmentForRanged(Enchantments.PUNCH, 2);
			Blitz                   .addEnchantmentForDamage(Enchantments.KNOCKBACK, 3).addEnchantmentForRanged(Enchantments.PUNCH, 3);
			Gravitite               .addEnchantmentForDamage(Enchantments.KNOCKBACK, 3).addEnchantmentForRanged(Enchantments.PUNCH, 3);
			DarkIron                .addEnchantmentForDamage(Enchantments.KNOCKBACK, 3).addEnchantmentForRanged(Enchantments.PUNCH, 3);
			Tartarite               .addEnchantmentForDamage(Enchantments.KNOCKBACK, 3).addEnchantmentForRanged(Enchantments.PUNCH, 3);
			DarkMatter              .addEnchantmentForDamage(Enchantments.KNOCKBACK, 3).addEnchantmentForRanged(Enchantments.PUNCH, 3);
			RedMeteor               .addEnchantmentForDamage(Enchantments.KNOCKBACK, 3).addEnchantmentForRanged(Enchantments.PUNCH, 3);
			Infinity                .addEnchantmentForDamage(Enchantments.KNOCKBACK,10).addEnchantmentForRanged(Enchantments.PUNCH,10);
			
			Skyroot                 .addEnchantmentForTools(Enchantments.FORTUNE, 1).addEnchantmentForWeapons(Enchantments.LOOTING, 1).addEnchantmentForAmmo(Enchantments.LOOTING, 2).addEnchantmentForRanged(Enchantments.INFINITY, 1).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 1);
			IronWood                .addEnchantmentForTools(Enchantments.FORTUNE, 1).addEnchantmentForWeapons(Enchantments.LOOTING, 1).addEnchantmentForAmmo(Enchantments.LOOTING, 2).addEnchantmentForRanged(Enchantments.INFINITY, 1).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 1);
			Steeleaf                .addEnchantmentForTools(Enchantments.FORTUNE, 2).addEnchantmentForWeapons(Enchantments.LOOTING, 2).addEnchantmentForAmmo(Enchantments.LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY, 2).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 2);
			Fireleaf                .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			Efrine                  .addEnchantmentForTools(Enchantments.FORTUNE, 2).addEnchantmentForWeapons(Enchantments.LOOTING, 2).addEnchantmentForAmmo(Enchantments.LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY, 2).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 2);
			Soularium               .addEnchantmentForTools(Enchantments.FORTUNE, 2).addEnchantmentForWeapons(Enchantments.LOOTING, 2).addEnchantmentForAmmo(Enchantments.LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY, 2).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 2);
			Midasium                .addEnchantmentForTools(Enchantments.FORTUNE, 2).addEnchantmentForWeapons(Enchantments.LOOTING, 2).addEnchantmentForAmmo(Enchantments.LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY, 2).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 2);
			Mithril                 .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			ElvenQuartz             .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			Vinteum                 .addEnchantmentForTools(Enchantments.FORTUNE, 1).addEnchantmentForWeapons(Enchantments.LOOTING, 1).addEnchantmentForAmmo(Enchantments.LOOTING, 2).addEnchantmentForRanged(Enchantments.INFINITY, 1).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 1);
			Manasteel               .addEnchantmentForTools(Enchantments.FORTUNE, 2).addEnchantmentForWeapons(Enchantments.LOOTING, 2).addEnchantmentForAmmo(Enchantments.LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY, 2).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 2);
			Thaumium                .addEnchantmentForTools(Enchantments.FORTUNE, 2).addEnchantmentForWeapons(Enchantments.LOOTING, 2).addEnchantmentForAmmo(Enchantments.LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY, 2).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 2);
			DarkThaumium            .addEnchantmentForTools(Enchantments.FORTUNE, 2).addEnchantmentForWeapons(Enchantments.LOOTING, 2).addEnchantmentForAmmo(Enchantments.LOOTING, 4).addEnchantmentForRanged(Enchantments.INFINITY, 2).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 2);
			VoidMetal               .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			InfusedWater            .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			Eximite                 .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			DarkMatter              .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			RedMatter               .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			Chimerite               .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			Jade                    .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			Sugilite                .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			EnderAmethyst           .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			Continuum               .addEnchantmentForTools(Enchantments.FORTUNE, 3).addEnchantmentForWeapons(Enchantments.LOOTING, 3).addEnchantmentForAmmo(Enchantments.LOOTING, 6).addEnchantmentForRanged(Enchantments.INFINITY, 3).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 3);
			Basalz                  .addEnchantmentForTools(Enchantments.FORTUNE, 4).addEnchantmentForWeapons(Enchantments.LOOTING, 4).addEnchantmentForAmmo(Enchantments.LOOTING, 8).addEnchantmentForRanged(Enchantments.INFINITY, 4).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 4);
			Carminite               .addEnchantmentForTools(Enchantments.FORTUNE, 4).addEnchantmentForWeapons(Enchantments.LOOTING, 4).addEnchantmentForAmmo(Enchantments.LOOTING, 8).addEnchantmentForRanged(Enchantments.INFINITY, 4).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 4);
			Ma                      .addEnchantmentForTools(Enchantments.FORTUNE, 4).addEnchantmentForWeapons(Enchantments.LOOTING, 4).addEnchantmentForAmmo(Enchantments.LOOTING, 8).addEnchantmentForRanged(Enchantments.INFINITY, 4).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 4);
			Haderoth                .addEnchantmentForTools(Enchantments.FORTUNE, 4).addEnchantmentForWeapons(Enchantments.LOOTING, 4).addEnchantmentForAmmo(Enchantments.LOOTING, 8).addEnchantmentForRanged(Enchantments.INFINITY, 4).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 4);
			VibraniumSteel          .addEnchantmentForTools(Enchantments.FORTUNE, 5).addEnchantmentForWeapons(Enchantments.LOOTING, 5).addEnchantmentForAmmo(Enchantments.LOOTING,10).addEnchantmentForRanged(Enchantments.INFINITY, 5).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 5);
			Vibramantium            .addEnchantmentForTools(Enchantments.FORTUNE, 5).addEnchantmentForWeapons(Enchantments.LOOTING, 5).addEnchantmentForAmmo(Enchantments.LOOTING,10).addEnchantmentForRanged(Enchantments.INFINITY, 5).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 5);
			Vb                      .addEnchantmentForTools(Enchantments.FORTUNE, 5).addEnchantmentForWeapons(Enchantments.LOOTING, 5).addEnchantmentForAmmo(Enchantments.LOOTING,10).addEnchantmentForRanged(Enchantments.INFINITY, 5).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA, 5);
			Infinity                .addEnchantmentForTools(Enchantments.FORTUNE,10).addEnchantmentForWeapons(Enchantments.LOOTING,10).addEnchantmentForAmmo(Enchantments.LOOTING,20).addEnchantmentForRanged(Enchantments.INFINITY,10).addEnchantmentForFishing(Enchantments.LUCK_OF_THE_SEA,10);
			...
			EnderPearl              .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1).addEnchantmentForRanged(Enchantments.INFINITY, 1);;
			Enderium                .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1).addEnchantmentForRanged(Enchantments.INFINITY, 2);;
			Endium                  .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1).addEnchantmentForRanged(Enchantments.INFINITY, 3);;
			SpectreIron             .addEnchantmentForTools(Enchantments.SILK_TOUCH, 1).addEnchantmentForRanged(Enchantments.INFINITY, 3);;
			
			Flint                   .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 1).addEnchantmentForRanged(Enchantments.FLAME, 1);
			Netherrack              .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 1).addEnchantmentForRanged(Enchantments.FLAME, 1);
			Obsidian                .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 1).addEnchantmentForRanged(Enchantments.FLAME, 1);
			STONES.Gneiss           .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAME, 2);
			NetherBrick             .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAME, 2);
			PO4                     .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAME, 2);
			Phosphorite             .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAME, 2);
			Phosphorus              .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAME, 2);
			PhosphorusBlue          .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAME, 2);
			PhosphorusRed           .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAME, 2);
			PhosphorusWhite         .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAME, 2);
			ObsidianSteel           .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAME, 2);
			Ignatius                .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 2).addEnchantmentForRanged(Enchantments.FLAME, 2);
			Sunstone                .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Prometheum              .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Octine                  .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Kreknorite              .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Firestone               .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Fireleaf                .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			FierySteel              .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			MeteoflameSteel         .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			MeteoflameBlackSteel    .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			MeteoflameBlueSteel     .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			MeteoflameRedSteel      .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			FlamascusSteel          .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Pyrotheum               .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Blaze                   .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			InfusedFire             .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Vulcanite               .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Amordrine               .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			MuspelheimPower         .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			RedMatter               .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Netherite               .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			NetherizedDiamond       .addEnchantmentForDamage(Enchantments.FIRE_ASPECT, 3).addEnchantmentForRanged(Enchantments.FLAME, 3).addEnchantmentForTools(Enchantments.FIRE_ASPECT, 3);
			Infinity                .addEnchantmentForDamage(Enchantments.FIRE_ASPECT,10).addEnchantmentForRanged(Enchantments.FLAME,10).addEnchantmentForTools(Enchantments.FIRE_ASPECT,10);
			...
			Fe                      .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER, 1);
			IronMagnetic            .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER, 1);
			IronWood                .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER, 1);
			Ice                     .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER, 1);
			Glass                   .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER, 1);
			Bronze                  .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER, 1);
			ArsenicCopper           .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER, 1);
			ArsenicBronze           .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER, 1);
			GildedIron              .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER, 1);
			PulsatingIron           .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER, 1);
			ConductiveIron          .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER, 1);
			RedstoneAlloy           .addEnchantmentForDamage(Enchantments.SHARPNESS, 1).addEnchantmentForRanged(Enchantments.POWER, 1);
			ElectricalSteel         .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			Brass                   .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			CobaltBrass             .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			HSLA                    .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			Steel                   .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			SteelMagnetic           .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			SteelGalvanized         .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			Syrmorite               .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			WroughtIron             .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			PigIron                 .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			Meteorite               .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			FierySteel              .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			FrozenIron              .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			MeteoricIron            .addEnchantmentForDamage(Enchantments.SHARPNESS, 2).addEnchantmentForRanged(Enchantments.POWER, 2);
			MeteoricSteel           .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			MeteoflameSteel         .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			Steeleaf                .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			Fireleaf                .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			VanadiumSteel           .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			StainlessSteel          .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			Knightmetal             .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			DeepIron                .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			ShadowIron              .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			BlackSteel              .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			MeteoricBlackSteel      .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			MeteoflameBlackSteel    .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			RedSteel                .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			MeteoricRedSteel        .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			MeteoflameRedSteel      .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			BlueSteel               .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			MeteoricBlueSteel       .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			MeteoflameBlueSteel     .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			Ti                      .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			TitaniumGold            .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			TungstenAlloy           .addEnchantmentForDamage(Enchantments.SHARPNESS, 3).addEnchantmentForRanged(Enchantments.POWER, 3);
			TungstenSteel           .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER, 4);
			NetherizedDiamond       .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER, 4);
			HSSG                    .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER, 4);
			HSSE                    .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER, 4);
			HSSS                    .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER, 4);
			ShadowSteel             .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER, 4);
			Zanite                  .addEnchantmentForDamage(Enchantments.SHARPNESS, 4).addEnchantmentForRanged(Enchantments.POWER, 4);
			DamascusSteel           .addEnchantmentForDamage(Enchantments.SHARPNESS, 5).addEnchantmentForRanged(Enchantments.POWER, 5);
			FlamascusSteel          .addEnchantmentForDamage(Enchantments.SHARPNESS, 5).addEnchantmentForRanged(Enchantments.POWER, 5);
			Elvorium                .addEnchantmentForDamage(Enchantments.SHARPNESS, 5).addEnchantmentForRanged(Enchantments.POWER, 5);
			InfusedEntropy          .addEnchantmentForDamage(Enchantments.SHARPNESS, 5).addEnchantmentForRanged(Enchantments.POWER, 5);
			Ke                      .addEnchantmentForDamage(Enchantments.SHARPNESS, 6).addEnchantmentForRanged(Enchantments.POWER, 6);
			Ad                      .addEnchantmentForDamage(Enchantments.SHARPNESS, 7).addEnchantmentForRanged(Enchantments.POWER, 7);
			Trinitanium             .addEnchantmentForDamage(Enchantments.SHARPNESS, 7).addEnchantmentForRanged(Enchantments.POWER, 7);
			Trinaquadalloy          .addEnchantmentForDamage(Enchantments.SHARPNESS, 8).addEnchantmentForRanged(Enchantments.POWER, 8);
			Infinity                .addEnchantmentForDamage(Enchantments.SHARPNESS,10).addEnchantmentForRanged(Enchantments.POWER,10);
			...
			Atl                     .addEnchantmentForArmors(Enchantments.FEATHER_FALLING, 4);
			InfusedFire             .addEnchantmentForArmors(Enchantments.FEATHER_FALLING, 4);
			Infinity                .addEnchantmentForArmors(Enchantments.FEATHER_FALLING,10);
			
			Steeleaf                .addEnchantmentForArmors(Enchantments.PROTECTION, 2);
			Fireleaf                .addEnchantmentForArmors(Enchantments.PROTECTION, 2);
			Knightmetal             .addEnchantmentForArmors(Enchantments.PROTECTION, 1);
			Celenegil               .addEnchantmentForArmors(Enchantments.PROTECTION, 4);
			InfusedEarth            .addEnchantmentForArmors(Enchantments.PROTECTION, 4);
			InfusedVis              .addEnchantmentForArmors(Enchantments.PROTECTION, 4);
			InfusedBalance          .addEnchantmentForArmors(Enchantments.PROTECTION, 4);
			Tartarite               .addEnchantmentForArmors(Enchantments.PROTECTION, 5);
			Adamantine              .addEnchantmentForArmors(Enchantments.PROTECTION, 5);
			DarkMatter              .addEnchantmentForArmors(Enchantments.PROTECTION, 5);
			VibraniumSilver         .addEnchantmentForArmors(Enchantments.PROTECTION, 6);
			VibraniumSteel          .addEnchantmentForArmors(Enchantments.PROTECTION, 8);
			Vibramantium            .addEnchantmentForArmors(Enchantments.PROTECTION,10);
			Vb                      .addEnchantmentForArmors(Enchantments.PROTECTION,10);
			Ad                      .addEnchantmentForArmors(Enchantments.PROTECTION,10);
			Infinity                .addEnchantmentForArmors(Enchantments.PROTECTION,10);
...
//      GlauconiteSand          = oredustelec( 9151, "Glauconite Sand"           , SET_DULL      , 130, 180,  60, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Al,K     ).setMcfg( 0, Al2O3          ,10*U, K                , 1*U, Mg               , 2*U, H2O              , 3*U, O                , 7*U)                        , // (K,Na)(Fe3+,Al,Mg)2(Si,Al)4O10(OH)2
	...
	public static class STONES {
		...
		// ADAPT-019 (слой AE2): .alloySimple() добавлен СВЕРХ оригинала — открывает синтез в тигле при 2200 K
		// по составу самого Грега (setMcfg выше). В 1.7.10 небесный камень поставлял метеорит AE2, который в
		// этом порте гашен (замещение генерации); состав и heat(2200) — дословно оригинал MT.java:3803.
		SkyStone     = stonecent( 8528, "Sky Stone"               ,  81,  92,  96, 255)                                                            .setMcfg( 0, Peridot        , 2*U, RareEarth        , 1*U, MeteoricIron     , 1*U, Obsidian         , 5*U).aspects(TC.VOLATUS     , 1).qual(1, 5.0, 64, 2).setGenerifying(Stone).heat(2200).alloySimple(),
