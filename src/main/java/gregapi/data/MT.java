...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     , SOFT).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                            ,
	...
	public static class TECH {
		...
		static void init() {
			...
			Hg                      .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 3);
			Ag                      .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 4);
			RedMeteor               .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 3);
			Electrum                .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 3);
			BlackBronze             .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 2);
			BlackSteel              .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 2);
			MeteoricBlackSteel      .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 2);
			MeteoflameBlackSteel    .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 2);
			RedSteel                .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 1);
			MeteoricRedSteel        .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 1);
			MeteoflameRedSteel      .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 1);
			BlueSteel               .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 3);
			MeteoricBlueSteel       .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 3);
			MeteoflameBlueSteel     .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 3);
			ElectrumFlux            .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 3);
			Meutoite                .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 3);
			SterlingSilver          .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 4);
			AstralSilver            .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 5);
			Desichalkos             .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 6);
			VibraniumSilver         .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 10);
			Infinity                .addEnchantmentForDamage(gregapi.enchants.Enchantment_EnderDamage.KEY, 10);
			KCl                     .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			KIO3                    .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 3);
			NaCl                    .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 3);
			As                      .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 3);
			Cu                      .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 4);
			Brass                   .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			CobaltBrass             .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			BismuthBronze           .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			RoseGold                .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			SterlingSilver          .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			Bronze                  .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			BlackBronze             .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			BlackSteel              .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			MeteoricBlackSteel      .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			MeteoflameBlackSteel    .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			RedSteel                .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			MeteoricRedSteel        .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			MeteoflameRedSteel      .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			BlueSteel               .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			MeteoricBlueSteel       .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			MeteoflameBlueSteel     .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 2);
			Constantan              .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 3);
			AnnealedCopper          .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 4);
			Hepatizon               .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 5);
			Vyroxeres               .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 5);
			ArsenicCopper           .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 5);
			ArsenicBronze           .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 7);
			Infinity                .addEnchantmentForDamage(gregapi.enchants.Enchantment_SlimeDamage.KEY, 10);
			Ir                      .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 6);
			Osmiridium              .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 6);
			HSSS                    .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 6);
			Moonstone               .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 5);
			Ag                      .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 4);
			Electrum                .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 3);
			BlackBronze             .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 2);
			BlackSteel              .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 2);
			MeteoricBlackSteel      .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 2);
			MeteoflameBlackSteel    .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 2);
			RedSteel                .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 1);
			MeteoricRedSteel        .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 1);
			MeteoflameRedSteel      .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 1);
			BlueSteel               .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 3);
			MeteoricBlueSteel       .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 3);
			MeteoflameBlueSteel     .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 3);
			SterlingSilver          .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 4);
			AstralSilver            .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 5);
			VibraniumSilver         .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 10);
			Craponite               .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 10);
			Tc                      .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 10);
			Infinity                .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 10);
			DiamondPink             .addEnchantmentForDamage(gregapi.enchants.Enchantment_WerewolfDamage.KEY, 10);
			Cyanite                 .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 1);
			Yellorium               .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 1);
			Blutonium               .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 2);
			Ludicrite               .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 4);
			Pu                      .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 1);
			U_235                   .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 2);
			Co_60                   .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 2);
			Pu_241                  .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 3);
			Pu_243                  .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 3);
			At                      .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 4);
			Am_241                  .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 4);
			Nq_528                  .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 4);
			Nq_522                  .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 5);
			CosmicNeutronium        .addEnchantmentForTools(gregapi.enchants.Enchantment_Radioactivity.KEY, 10);
