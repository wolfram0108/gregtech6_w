...
//      OM.reg("cropPinecone"                       , ST.make(MD.DYNAMIC_TREES, "acaciaseed" , 1, 0));
	...
	//  OM.reg(OD.container1000turpentine           , ST.make(MD.BINNIE, "containerBucket", 1,131));
		...
		OM.reg(OD.dirt                              , ST.make(Blocks.DIRT, 1, 0));
		OM.reg(OD.sand                              , ST.make(Blocks.SAND, 1, 0));
		OM.reg(OD.gravel                            , ST.make(Blocks.GRAVEL, 1, W));
		OM.reg(OD.soulsand                          , ST.make(Blocks.SOUL_SAND, 1, W));
		OM.reg(OD.itemGrassTall                     , ST.make(Blocks.DEAD_BUSH, 1, 1));
		OM.reg(OD.itemGrassTall                     , ST.make(Blocks.FERN, 1, 0));
		...
		OM.reg(OD.blockGlass                        , ST.make(Blocks.WHITE_STAINED_GLASS, 1, 0));
		OM.reg(OD.blockGlassColorless               , ST.make(Blocks.GLASS, 1, W));
		OM.reg(OD.blockGlassColorless               , ST.make(MD.CHSL, "glass", 1, W));
		OM.reg(OD.paneGlass                         , ST.make(Blocks.WHITE_STAINED_GLASS_PANE, 1, 0));
		...
		OM.reg("bottlePoison"                       , ST.make(Items.POTION, 1,  8196));
		OM.reg("bottlePoison"                       , ST.make(Items.POTION, 1,  8228));
		OM.reg("bottlePoison"                       , ST.make(Items.POTION, 1,  8260));
		OM.reg("bottlePoison"                       , ST.make(Items.POTION, 1, 16388));
		OM.reg("bottlePoison"                       , ST.make(Items.POTION, 1, 16420));
		OM.reg("bottlePoison"                       , ST.make(Items.POTION, 1, 16452));
		...
		OM.reg(OD.buttonWood                        , ST.make(Blocks.OAK_BUTTON, 1, W));
		...
		OM.reg(OD.craftingHardenedClay              , ST.make(Blocks.WHITE_TERRACOTTA, 1, 0));
		...
		for (byte i = 0; i < 16; i++) OM.reg(OP.dyeMixable.mNameInternal + DYE_OREDICTS_POST[i], ST.make(Items.INK_SAC, 1, i));
...
//      OM.reg(OP.stone, MT.CrackedSand                         , ST.make(MD.EBXL, "terrain_blocks2"    , 1, 0));
		...
		OM.reg(OP.stoneSmooth                                   , ST.make(Blocks.STONE, 1, 0));
		OM.reg(OP.stoneBricks                                   , ST.make(Blocks.STONE_BRICKS, 1, 0));
		OM.reg(OP.stoneMossy                                    , ST.make(Blocks.MOSSY_STONE_BRICKS, 1, 0));
		OM.reg(OP.stoneMossyBricks                              , ST.make(Blocks.MOSSY_STONE_BRICKS, 1, 0));
		OM.reg(OP.stoneCracked                                  , ST.make(Blocks.CRACKED_STONE_BRICKS, 1, 0));
		OM.reg(OP.stoneChiseled                                 , ST.make(Blocks.CHISELED_STONE_BRICKS, 1, 0));
		OM.reg(OP.stone, MT.Sand                                , ST.make(Blocks.SANDSTONE, 1, 0));
...
//      OM.data(MD.TCFM, "WandCaps"                         , 1,   0, MT.Alchemical         ,  5* U9);
		...
		OM.data(ST.make(Blocks.SNOW                    , 1, W), MT.Snow               ,     -1);
		OM.data(ST.make(Blocks.REDSTONE_LAMP                 , 1, W), ANY.Glowstone         ,  U * 4, MT.Redstone, U * 4);
		OM.data(ST.make(Blocks.REDSTONE_LAMP             , 1, W), ANY.Glowstone         ,  U * 4, MT.Redstone, U * 4);
		OM.data(ST.make(Items.SKELETON_SKULL                          , 1, 1), MT.BoneWither         ,  U * 9);
		OM.data(ST.make(Items.SKELETON_SKULL                          , 1, 0), MT.Bone               ,  U * 9);
		...
		OM.data(ST.make(Blocks.WHITE_TERRACOTTA, 1, 0), MT.Ceramic            ,  U * 4);
		...
		OM.data(ST.make(Blocks.STONE_SLAB             , 1, 4), MT.Brick              ,  U * 4);
		OM.data(ST.make(Blocks.BRICK_STAIRS                  , 1, W), MT.Brick              ,  U * 3);
		OM.data(ST.make(Blocks.BRICK_SLAB, 1, 0), MT.Brick              ,  U * 2);
		OM.data(ST.make(Blocks.NETHER_BRICKS                  , 1, W), MT.NetherBrick        ,  U * 4);
		OM.data(ST.make(Blocks.STONE_SLAB             , 1, 6), MT.NetherBrick        ,  U * 4);
		OM.data(ST.make(Blocks.NETHER_BRICK_STAIRS           , 1, W), MT.NetherBrick        ,  U * 3);
		OM.data(ST.make(Blocks.NETHER_BRICK_SLAB, 1, 0), MT.NetherBrick        ,  U * 2);
		OM.data(ST.make(Blocks.NETHER_BRICK_FENCE            , 1, W), MT.NetherBrick        ,  U * 3);
		OM.data(ST.make(Blocks.QUARTZ_BLOCK, 1, 0), MT.NetherQuartz       ,  U * 4);
		...
		OM.data(ST.make(Blocks.WHITE_STAINED_GLASS, 1, 0), MT.Glass              ,  U*9);
		OM.data(ST.make(Blocks.GLASS                         , 1, W), MT.Glass              ,  U*9);
		OM.data(ST.make(Blocks.WHITE_STAINED_GLASS_PANE, 1, 0), MT.Glass              ,  U);
		...
		OM.data(ST.make(Blocks.SANDSTONE, 1, 0), MT.Sand               ,  U * 9);
		...
		OM.data(ST.make(Blocks.STONE_SLAB             , 1, 0), ANY.Stone             ,  U * 9);
		OM.data(ST.make(Blocks.STONE_SLAB             , 1, 8), ANY.Stone             ,  U * 9);
		OM.data(ST.make(Blocks.SANDSTONE_SLAB, 1, 0), MT.Sand               ,  U2* 9);
		OM.data(ST.make(Blocks.STONE_SLAB                    , 1, 9), MT.Sand               ,  U2* 9);
		OM.data(ST.make(Blocks.STONE_SLAB             , 1, 1), MT.Sand               ,  U * 9);
		OM.data(ST.make(Blocks.STONE_SLAB             , 1, 9), MT.Sand               ,  U * 9);
		OM.data(ST.make(Blocks.PETRIFIED_OAK_SLAB, 1, 0), MT.PetrifiedWood      ,  U2);
		OM.data(ST.make(Blocks.STONE_SLAB                    , 1,10), MT.PetrifiedWood      ,  U2);
		OM.data(ST.make(Blocks.STONE_SLAB             , 1, 2), MT.PetrifiedWood      ,  U * 1);
		OM.data(ST.make(Blocks.STONE_SLAB             , 1,10), MT.PetrifiedWood      ,  U * 1);
		OM.data(ST.make(Blocks.COBBLESTONE_SLAB, 1, 0), ANY.Stone             ,  U2* 9);
		OM.data(ST.make(Blocks.STONE_SLAB                    , 1,11), ANY.Stone             ,  U2* 9);
		OM.data(ST.make(Blocks.STONE_SLAB             , 1, 3), ANY.Stone             ,  U * 9);
		OM.data(ST.make(Blocks.STONE_SLAB             , 1,11), ANY.Stone             ,  U * 9);
		OM.data(ST.make(Blocks.STONE_BRICK_SLAB, 1, 0), ANY.Stone             ,  U2* 9);
		OM.data(ST.make(Blocks.STONE_SLAB                    , 1,13), ANY.Stone             ,  U2* 9);
		OM.data(ST.make(Blocks.STONE_SLAB             , 1, 5), ANY.Stone             ,  U * 9);
		OM.data(ST.make(Blocks.STONE_SLAB             , 1,13), ANY.Stone             ,  U * 9);
		OM.data(ST.make(Blocks.STONE, 1, 0), ANY.Stone             ,  U * 9);
		OM.data(ST.make(Blocks.FURNACE                       , 1, W), ANY.Stone             ,  U * 8);
		OM.data(ST.make(Blocks.FURNACE                   , 1, W), ANY.Stone             ,  U * 8);
		OM.data(ST.make(Blocks.STONE_BRICKS, 1, 0), ANY.Stone             ,  U * 9);
		...
		OM.data(ST.make(Blocks.DEAD_BUSH                      , 1, W), MT.WOODS.Dead         ,  U * 1);
		OM.data(ST.make(Blocks.DEAD_BUSH, 1, 0), MT.WOODS.Dead         ,  U * 1);
		OM.data(ST.make(Blocks.LADDER                        , 1, W), ANY.Wood              ,  3 *U7);
		OM.data(ST.make(Blocks.OAK_BUTTON                 , 1, W), ANY.Wood              ,  U * 1);
		OM.data(ST.make(Blocks.OAK_PRESSURE_PLATE         , 1, W), ANY.Wood              ,  U * 2);
		OM.data(ST.make(Blocks.OAK_FENCE                         , 1, W), ANY.Wood              ,  3 *U2);
		...
		OM.data(ST.make(Items.COD, 1, 0), MT.FishRaw            ,  U * 2, MT.Bone, U9, MT.FishOil, U * 2);
		OM.data(ST.make(Items.SALMON, 1, 0), MT.FishRaw            ,  U * 2, MT.Bone, U9, MT.FishOil, U * 4);
		OM.data(ST.make(Items.COD                           , 1, 2), MT.FishRaw            ,  U * 2, MT.Bone, U9, MT.FishOil, U * 1);
		OM.data(ST.make(Items.PUFFERFISH, 1, 0), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U * 1);
		if (MD.MaCu.mLoaded && MD.ENCHIRIDION.mLoaded) {
		OM.data(ST.make(Items.COD                           , 1, 4), MT.FishRaw            ,  U * 2, MT.Bone, U9, MT.FishOil, U * 2, ANY.Glowstone, U72);
		OM.data(ST.make(Items.COD                           , 1, 5), MT.FishRaw            ,  U * 1, MT.Bone, U9, MT.FishOil, U * 1, MT.Blaze, U9);
		OM.data(ST.make(Items.COD                           , 1, 6), MT.FishRaw            ,  U2   , MT.Bone, U3, MT.FishOil, U3);
		OM.data(ST.make(Items.COD                           , 1, 7), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2);
		OM.data(ST.make(Items.COD                           , 1, 8), MT.FishRaw            ,  U * 4, MT.Bone, U2, MT.FishOil, U * 7);
		OM.data(ST.make(Items.COD                           , 1, 9), MT.FishRaw            ,  U2   , MT.Bone, U3, MT.FishOil, U4);
		OM.data(ST.make(Items.COD                           , 1,10), MT.FishRaw            ,  U * 2, MT.Bone, U9, MT.FishOil, U4);
		OM.data(ST.make(Items.COD                           , 1,11), MT.FishRaw            ,  U * 2, MT.Bone, U9, MT.FishOil, U * 4, MT.Gunpowder,  U9);
		OM.data(ST.make(Items.COD                           , 1,12), MT.FishRaw            ,  U2   , MT.Bone, U3, MT.FishOil, U40);
		OM.data(ST.make(Items.COD                           , 1,13), MT.FishRaw            ,  U * 3, MT.Bone, U3, MT.FishOil, U * 2);
		OM.data(ST.make(Items.COD                           , 1,14), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U * 3);
		OM.data(ST.make(Items.COD                           , 1,15), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U * 2);
		OM.data(ST.make(Items.COD                           , 1,16), MT.FishRaw            ,  U * 3, MT.Bone, U3, MT.FishOil, U * 6);
		OM.data(ST.make(Items.COD                           , 1,17), MT.FishRaw            ,  U * 2, MT.Bone, U3, MT.FishOil, U * 6);
		OM.data(ST.make(Items.COD                           , 1,18), MT.FishRaw            ,  U2   , MT.Bone, U3, MT.FishOil, U * 1);
		OM.data(ST.make(Items.COD                           , 1,19), MT.FishRaw            ,  U2   , MT.Bone, U3, MT.FishOil, U * 1);
		OM.data(ST.make(Items.COD                           , 1,20), MT.FishRaw            ,  U2   , MT.Bone, U3, MT.FishOil, U2);
		OM.data(ST.make(Items.COD                           , 1,21), MT.FishRaw            ,  U * 3, MT.FishOil, U * 5);
		OM.data(ST.make(Items.COD                           , 1,22), MT.FishOil            ,  U * 5);
		OM.data(ST.make(Items.COD                           , 1,23), MT.FishOil            ,  U * 5);
		OM.data(ST.make(Items.COD                           , 1,24), MT.FishRaw            ,  U2   , MT.Bone, U9, MT.FishOil, U * 1, MT.Au, U72);
		OM.data(ST.make(Items.COD                           , 1,25), MT.FishRaw            ,  U2   , MT.Bone, U3, MT.FishOil, U100);
		OM.data(ST.make(Items.COD                           , 1,26), MT.FishRaw            ,  U * 3, MT.Bone, U3, MT.FishOil, U * 5);
		OM.data(ST.make(Items.COD                           , 1,27), MT.FishRaw            ,  U2   , MT.Bone, U9, MT.FishOil, U10);
		OM.data(ST.make(Items.COD                           , 1,28), MT.FishRaw            ,  U2   , MT.Bone, U9, MT.FishOil, U * 1, MT.Lapis,  U9);
		OM.data(ST.make(Items.COD                           , 1,29), MT.FishRaw            ,  U * 3, MT.Bone, U3, MT.FishOil, U * 3);
		OM.data(ST.make(Items.COD                           , 1,30), MT.FishRaw            ,  U2   , MT.Bone, U3, MT.FishOil, U2);
		OM.data(ST.make(Items.COD                           , 1,31), MT.FishRaw            ,  U * 2, MT.Bone, U3, MT.FishOil, U * 4);
		OM.data(ST.make(Items.COD                           , 1,32), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U * 2);
		OM.data(ST.make(Items.COD                           , 1,33), MT.FishRaw            ,  U2   , MT.Bone, U9, MT.FishOil, U * 1);
		OM.data(ST.make(Items.COD                           , 1,34), MT.FishRotten         ,  U * 2, MT.Bone, U3, MT.FishOil, U * 1);
		OM.data(ST.make(Items.COD                           , 1,35), MT.Bone               ,  U * 6);
		OM.data(ST.make(Items.COD                           , 1,36), MT.FishRaw            ,  U * 2, MT.Bone, U3, MT.FishOil, U * 4);
		OM.data(ST.make(Items.COD                           , 1,37), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U * 3);
		OM.data(ST.make(Items.COD                           , 1,38), MT.FishRaw            ,  U * 1, MT.Bone, U9, MT.FishOil, U * 1, MT.Redstone,  U4);
		OM.data(ST.make(Items.COD                           , 1,39), MT.FishRaw            ,  U * 2, MT.Bone, U9, MT.FishOil, U * 2);
		OM.data(ST.make(Items.COD                           , 1,40), MT.FishRaw            ,  U * 1, MT.Bone, U9, MT.FishOil, U * 1);
		OM.data(ST.make(Items.COD                           , 1,41), MT.FishRaw            ,  U * 1, MT.Bone, U9, MT.FishOil, U2);
		OM.data(ST.make(Items.COD                           , 1,42), MT.FishRaw            ,  U2   , MT.Bone, U3, MT.FishOil, U20);
		OM.data(ST.make(Items.COD                           , 1,43), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U * 1);
		OM.data(ST.make(Items.COD                           , 1,44), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U * 3);
		OM.data(ST.make(Items.COD                           , 1,45), MT.FishRaw            ,  U * 2, MT.Bone, U3, MT.FishOil, U * 4);
		OM.data(ST.make(Items.COD                           , 1,46), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U * 3);
		OM.data(ST.make(Items.COD                           , 1,47), MT.FishRaw            ,  U * 2, MT.Bone, U3, MT.FishOil, U * 5);
		OM.data(ST.make(Items.COD                           , 1,48), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U20);
		OM.data(ST.make(Items.COD                           , 1,49), MT.FishRaw            ,  U2   , MT.Bone, U3, MT.FishOil, U * 2);
		OM.data(ST.make(Items.COD                           , 1,50), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Fe, U72);
		OM.data(ST.make(Items.COD                           , 1,51), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Au, U72);
		OM.data(ST.make(Items.COD                           , 1,52), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Cu, U72);
		OM.data(ST.make(Items.COD                           , 1,53), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Al2O3, U72);
		OM.data(ST.make(Items.COD                           , 1,54), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.TiO2, U72);
		OM.data(ST.make(Items.COD                           , 1,55), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Mg, U72);
		OM.data(ST.make(Items.COD                           , 1,56), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Ag, U72);
		OM.data(ST.make(Items.COD                           , 1,57), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Pb, U72);
		OM.data(ST.make(Items.COD                           , 1,58), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Sn, U72);
		OM.data(ST.make(Items.COD                           , 1,59), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Pt, U72);
		OM.data(ST.make(Items.COD                           , 1,60), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Ni, U72);
		OM.data(ST.make(Items.COD                           , 1,61), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Co, U72);
		OM.data(ST.make(Items.COD                           , 1,62), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Ardite, U72);
		OM.data(ST.make(Items.COD                           , 1,63), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Os, U72);
		OM.data(ST.make(Items.COD                           , 1,64), MT.FishRaw            ,  U * 1, MT.Bone, U3, MT.FishOil, U2, MT.Zn, U72);
		}
		OM.data(ST.make(Items.COD, 1, 0), MT.FishRaw            ,  U * 2, MT.Bone, U9, MT.FishOil, U * 1);
	}
}
