...
//      OreDictManager.INSTANCE.setTarget(OP.oreBlackstone  , MT.Au                     , MD.NeLi, "Blackstone", 5); // DONT! This thing is crafted with 4 Nuggets and a Blackstone!
		...
		OreDictManager.INSTANCE.setTarget(OP.bottle         , MT.H2O                    , ST.make(Items.POTION, 1, 0));
		...
		OreDictManager.INSTANCE.setTarget(OP.gem            , MT.Charcoal               , ST.make(Items.CHARCOAL, 1, 0));
		...
		OreDictManager.INSTANCE.setTarget(OP.ingot          , MT.NetherBrick            , ST.make(Items.NETHER_BRICK, 1, 0));
		...
		OreDictManager.INSTANCE.setTarget(OP.dust           , MT.Bone                   , ST.make(Items.BONE_MEAL, 1, 0));
