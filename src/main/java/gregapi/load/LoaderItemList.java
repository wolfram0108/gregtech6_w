...
public class LoaderItemList implements Runnable {
	...
	@Override
	public void run() {
		BlocksGT.EtFu_Beetroot_Crop              = net.minecraft.core.registries.BuiltInRegistries.BLOCK.get(new net.minecraft.resources.ResourceLocation(MD.EtFu.mID, "beetroots"));
		BlocksGT.EtFu_Deepslate_Redstone_Ore     = net.minecraft.core.registries.BuiltInRegistries.BLOCK.get(new net.minecraft.resources.ResourceLocation(MD.EtFu.mID, "deepslate_redstone_ore"));
		BlocksGT.EtFu_Deepslate_Lit_Redstone_Ore = net.minecraft.core.registries.BuiltInRegistries.BLOCK.get(new net.minecraft.resources.ResourceLocation(MD.EtFu.mID, "deepslate_lit_redstone_ore"));
