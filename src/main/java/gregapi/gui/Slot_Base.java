...
public class Slot_Base extends Slot {
	...
	protected Slot_Base(ITileEntityInventoryGUI aInventory, int aIndex, int aX, int aY) {
		super(aInventory instanceof AbstractContainerMenu ? (AbstractContainerMenu)aInventory : null, aIndex, aX, aY);
	...
	@Override public boolean isSlotInInventory(AbstractContainerMenu aInventory, int aIndex) {return aInventory == mInventory && aIndex == mIndex;}
