 ...
 *  Deliberately bypasses the GT6 GUI abstraction and writes through the raw base Slot container field, as
 *  the original did; needs no EMPTY<->null bridge since callers already pass neo-convention stacks. */
