...
public class DungeonChunkBarracks extends DungeonChunkRoomEmpty {
	...
	public boolean generate(DungeonData aData) {
		...
		aData.set( 1, 1,  1, Blocks.WHITE_BED,10, 2);
		aData.set( 1, 1,  2, Blocks.WHITE_BED, 2, 2);
		aData.set( 1, 1, 13, Blocks.WHITE_BED, 0, 2);
		aData.set( 1, 1, 14, Blocks.WHITE_BED, 8, 2);
		aData.set(14, 1,  1, Blocks.WHITE_BED,10, 2);
		aData.set(14, 1,  2, Blocks.WHITE_BED, 2, 2);
		aData.set(14, 1, 13, Blocks.WHITE_BED, 0, 2);
		aData.set(14, 1, 14, Blocks.WHITE_BED, 8, 2);
