...
public class DungeonChunkRoomFarmFish extends DungeonChunkRoomEmpty {
	...
	public boolean generate(DungeonData aData) {
		...
		if (tFishTrap != null) {
			...
			BlockEntity
			tTileEntity = WD.te(aData.mWorld, aData.mX+6, aData.mY, aData.mZ+6, T); if (tTileEntity instanceof Container) ((Container)tTileEntity).setItem(18, ST.make(MD.HaC, "fishtrapbaitItem", aData.nextStack()));
			tTileEntity = WD.te(aData.mWorld, aData.mX+6, aData.mY, aData.mZ+9, T); if (tTileEntity instanceof Container) ((Container)tTileEntity).setItem(18, ST.make(MD.HaC, "fishtrapbaitItem", aData.nextStack()));
			tTileEntity = WD.te(aData.mWorld, aData.mX+9, aData.mY, aData.mZ+6, T); if (tTileEntity instanceof Container) ((Container)tTileEntity).setItem(18, ST.make(MD.HaC, "fishtrapbaitItem", aData.nextStack()));
			tTileEntity = WD.te(aData.mWorld, aData.mX+9, aData.mY, aData.mZ+9, T); if (tTileEntity instanceof Container) ((Container)tTileEntity).setItem(18, ST.make(MD.HaC, "fishtrapbaitItem", aData.nextStack()));
		}
