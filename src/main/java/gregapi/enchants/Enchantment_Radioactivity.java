...
public class Enchantment_Radioactivity extends DamageEnchantment {
	...
	public Enchantment_Radioactivity() {
		// Materials also attach Radioactivity to ARMOR slots beyond MAINHAND via addEnchantmentForArmors in MT.init;
		// the original caught those through its own getLastActiveItems dispatcher.
