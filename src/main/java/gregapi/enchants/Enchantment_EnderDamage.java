 ...
 */
public class Enchantment_EnderDamage extends DamageEnchantment {
	public static final Enchantment_EnderDamage INSTANCE = new Enchantment_EnderDamage();
	
	public Enchantment_EnderDamage() {
		super(Enchantment.Rarity.RARE, -1, EquipmentSlot.MAINHAND);
		LH.add(getDescriptionId(), "Disjunction");
	}
	...
	public void doPostHurt(LivingEntity aHurtEntity, Entity aDamagingEntity, int aLevel) {
		EnchantmentEffect_Ender.apply(aHurtEntity, aLevel);
	}
