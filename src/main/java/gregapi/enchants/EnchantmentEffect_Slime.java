 ...
 *
 * Игровая логика чара {@code Enchantment_SlimeDamage} (оригинал 1.7.10 —
 * {@code gregapi/enchants/Enchantment_SlimeDamage.java:82-92}, метод {@code func_151367_b}).
 ...
 * обычный метод, вызываемый из {@link Enchantment_SlimeDamage}. Значения не изменены.
 */
public final class EnchantmentEffect_Slime {
	private EnchantmentEffect_Slime() {}

	public static void apply(Entity aEntity, int aLevel) {
		if (aEntity instanceof LivingEntity aHurtEntity && UT.Entities.isSlimeCreature(aHurtEntity)) {
