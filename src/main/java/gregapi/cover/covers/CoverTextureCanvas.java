...
public class CoverTextureCanvas extends AbstractCoverDefault {
	...
	public void onCoverLoaded(byte aSide, CoverData aData) {
		...
		aData.visual(aSide, (short)((net.minecraft.core.registries.BuiltInRegistries.BLOCK.getId(ST.getBlock(aData.mNBTs[aSide], NBT_CANVAS_BLOCK)) << 4) | (aData.mNBTs[aSide].getInt(NBT_CANVAS_META) & 15)));
	}
