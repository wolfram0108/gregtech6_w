...
public class CompatGC extends CompatBase implements ICompatGC {
	...
	public void populate(GCCoreEventPopulate.Post aEvent) {
		// GT6WorldGenerator now runs on the data-driven WorldGenLevel feature path; the GC populate event only
		// hands a full Level, which cannot feed it directly, so this is a deliberate no-op until GC itself is ported.
