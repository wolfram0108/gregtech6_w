...
/** Compile-only mirror of the Thaumcraft API: only the base class the deprecated
 *  ContainerArcaneWorkbenchFixed extends, a path that never runs without the real mod. */
