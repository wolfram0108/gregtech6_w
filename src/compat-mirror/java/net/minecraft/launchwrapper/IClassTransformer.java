...
/** Compile-only shim for the legacy FML launchwrapper, absent from the neo classpath; NeoForge uses Mixin instead.
 *  PORT-TODO(F2, mixin-cycle): this coremod path is inactive at runtime until replaced with real Mixin. */
