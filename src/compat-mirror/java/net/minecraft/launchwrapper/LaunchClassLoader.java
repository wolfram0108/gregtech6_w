...
/** Compile-only shim for the legacy FML launchwrapper; extends ClassLoader only so a narrowing
 *  cast to it type-checks, and registerTransformer is an honest no-op since this path never runs. */
