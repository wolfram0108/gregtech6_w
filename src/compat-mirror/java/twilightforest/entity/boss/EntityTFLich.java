...
/** Compile-only mirror of the Twilight Forest API: the minimum needed for GregTech6's instanceof checks. */
public abstract class EntityTFLich extends PathfinderMob {
    protected EntityTFLich(EntityType<? extends PathfinderMob> aType, Level aLevel) {
        super(aType, aLevel);
    }
}
