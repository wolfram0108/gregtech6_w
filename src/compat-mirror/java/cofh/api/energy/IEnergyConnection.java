...
/** Compile-only mirror of the CoFH RF energy API: only canConnectEnergy is actually called
 *  (EnergyCompat); getEnergyStored/getMaxEnergyStored are unused and left out. */
