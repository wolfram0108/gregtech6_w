...
/** Compile-only mirror of the CoFH RF energy API's older shape, where some mods declare
 *  receiveEnergy directly here rather than only on IEnergyReceiver; only that method is actually called. */
