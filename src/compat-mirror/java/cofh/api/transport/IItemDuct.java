...
/** Compile-only mirror of the CoFH API: GregTech6 calls this interface (casting an external
 *  block entity) rather than implementing it; the real mod never loads, so integration stays deferred. */
