...
/** Compile-only mirror: GT_API_Proxy casts objects from a foreign Map/Set to this type and
 *  reads/writes its item/metadata fields directly, so only those public fields are mirrored, not the constructor. */
