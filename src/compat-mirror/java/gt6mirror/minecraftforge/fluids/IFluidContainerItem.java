...
/** Live bridge, not a compile-only shim: Forge 1.7.10's IFluidContainerItem has no 1:1 neo
 *  replacement, since a singleton Item can't return per-stack state; null-when-empty semantics are kept exactly. */
