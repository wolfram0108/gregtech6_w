...
/** Compile-only mirror of the WarpDrive API: GregTech6 calls the static registerBlockTransformer
 *  from CompatWD's constructor, but the real mod never loads, so this is a no-op. */
