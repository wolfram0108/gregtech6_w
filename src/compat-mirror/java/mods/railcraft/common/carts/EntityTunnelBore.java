...
/** Compile-only mirror of the Railcraft API: only the two addMineableBlock overloads GregTech6
 *  actually calls; the rest of the real cart-entity class is unused and left out. */
