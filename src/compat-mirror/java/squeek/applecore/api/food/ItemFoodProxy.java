...
/** Compile-only mirror of the AppleCore API, built via reflection to wrap GregTech6's item; kept
 *  minimal because neo's FoodData has no addStats equivalent, so it awaits a real AppleCore port. */
