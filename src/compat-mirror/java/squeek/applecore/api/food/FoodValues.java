...
/** Compile-only mirror of the AppleCore API: the constructor signature GregTech6 actually builds,
 *  (hunger, saturationModifier), matching every IEdible.getFoodValues() call site. */
