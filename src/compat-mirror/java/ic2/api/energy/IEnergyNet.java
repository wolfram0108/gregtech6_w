...
/** Compile-only mirror of the IC2 API: the real type of EnergyNet.instance; only getTileEntity
 *  is actually called, so the rest of the real interface is left out. */
