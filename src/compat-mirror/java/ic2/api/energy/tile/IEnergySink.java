...
/** Compile-only mirror of the IC2 API: acceptsEnergyFrom is declared directly here rather than
 *  inherited through IEnergyAcceptor, since the compiler only needs the signature at the call site. */
