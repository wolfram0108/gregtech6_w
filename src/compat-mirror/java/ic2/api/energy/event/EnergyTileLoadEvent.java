...
/** Compile-only mirror of the IC2 API: extends neo's Event class (instead of the real Forge
 *  event type) only so GregTech6 can post it; with no IC2 subscribers listening, posting is a no-op. */
