...
/** Compile-only mirror of the IC2 API: only the four heat/output accessors WD actually calls
 *  are mirrored; the rest of the real interface's large surface is unused and left out. */
