...
public class RecipeInputItemStack implements IRecipeInput {
	public ItemStack input; // actually read by GregTech6's Loader_Recipes_Replace as an ItemStack
	public RecipeInputItemStack(ItemStack aInput, int aAmount) {input = aInput;}
	@Override public boolean matches(ItemStack aStack) {return false;} // compile-only mirror; the real mod never loads
}
