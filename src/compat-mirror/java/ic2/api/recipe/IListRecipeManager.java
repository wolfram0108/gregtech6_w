...
/** Compile-only mirror of the IC2 API: the real type of Recipes.recyclerBlacklist/Whitelist;
 *  only add, contains, and isEmpty are actually called, so the rest is left out. */
