...
/** Compile-only mirror of the IC2 API: only charge and discharge are actually called, matching
 *  the real signatures exactly; the rest of the real interface is unused and left out. */
