...
/** Compile-only mirror of the IC2 API: only the static manager field CompatIC2EUItem checks
 *  and calls charge()/discharge() on; the rest of the real class is unused and left out. */
