...
/** Compile-only mirror of the IC2 API: only getTier, canProvideEnergy, and getMaxCharge are
 *  actually called, from CompatIC2EUItem; the rest of the real interface is left out. */
