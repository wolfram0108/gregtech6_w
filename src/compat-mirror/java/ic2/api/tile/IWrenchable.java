...
/** Compile-only mirror of the IC2 API, verified against the real IC2Classic jar; the methods
 *  WD and ToolCompat actually call, with EntityPlayer replaced by neo's Player as elsewhere in the port. */
