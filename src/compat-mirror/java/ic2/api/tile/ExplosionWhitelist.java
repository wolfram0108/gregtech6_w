...
/** Compile-only mirror of the IC2 API: only isBlockWhitelisted and addWhitelistedBlock are
 *  actually called, from CompatIC2; removeWhitelistedBlock is unused and left out. */
