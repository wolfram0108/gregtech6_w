...
/** Compile-only mirror of the IC2 API: only the methods GregTech6 actually calls through
 *  instanceof/cast are mirrored; the rest of the real interface's surface is unused and left out. */
