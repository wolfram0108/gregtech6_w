...
/** Compile-only mirror of the IC2 API: flat fields instead of extending the real WorldEvent
 *  hierarchy, since neo has no equivalent and the compiler only needs the fields CompatIC2 reads. */
