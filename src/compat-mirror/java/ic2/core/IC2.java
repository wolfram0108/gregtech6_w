...
/** Compile-only mirror of the IC2 API: only addValuableOre is actually called, from CompatIC2;
 *  the rest of the real class's large surface is unused and left out. */
public class IC2 {
	public static void addValuableOre(IRecipeInput aInput, int aValue) {/**/}

	/** Compile-only mirror of the IC2 achievements API; the real mod initializes this at runtime,
	 *  reached only when MD.IC.mLoaded is true. */
