...
/** Compile-only mirror of the BuildCraft API: GregTech6 calls the static registerWorldProperty
 *  from CompatBC.onServerStarting, but the real mod never loads, so this is a no-op. */
