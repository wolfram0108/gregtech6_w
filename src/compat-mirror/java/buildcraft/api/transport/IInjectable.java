...
/** Compile-only mirror of the BuildCraft API: GregTech6 calls this interface (casting an external
 *  block entity) rather than implementing it; the color parameter is Object because it is always null here. */
