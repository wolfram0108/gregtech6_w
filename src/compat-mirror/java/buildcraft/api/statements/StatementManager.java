...
/** Compile-only mirror of the BuildCraft API: GregTech6 calls the static registerStatement and
 *  registerTriggerProvider during TriggerBC setup, but the real mod never loads, so this is a no-op. */
