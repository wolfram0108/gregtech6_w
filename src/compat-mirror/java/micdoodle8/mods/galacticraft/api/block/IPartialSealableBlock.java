...
/** Compile-only mirror of the Galacticraft API: GregTech6 casts a block to this interface
 *  rather than implementing it, and the branch is dead without the real mod loaded. */
