...
/** Compile-only mirror of the Galacticraft API: returns true because without the real mod this
 *  path is unreachable, which is the normal "ordinary world, has oxygen" case. */
