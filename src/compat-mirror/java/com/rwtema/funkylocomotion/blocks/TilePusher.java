...
/** Compile-only mirror of the FunkyLocomotion API, kept as an interface rather than a class
 *  because EnergyCompat casts a BlockEntity to it and a concrete class would fail that check. */
