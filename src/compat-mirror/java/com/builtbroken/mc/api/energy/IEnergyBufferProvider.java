...
/** Compile-only mirror of the Voltz/UniversalElectricity energy API: EnergyCompat assigns the
 *  getEnergyBuffer result to Object and casts it immediately, so that is the signature mirrored here. */
