...
/** Compile-only mirror of legacy Forge/FML 1.7.10; @Mod itself appears only in commented-out
 *  example code, but the nested @Mod.EventHandler annotation is genuinely used elsewhere. */
