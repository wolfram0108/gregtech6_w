...
/** Compile-only mirror of the InvTweaks annotation: GregTech6 marks its Container classes with it
 *  for inventory sorting; the annotation is pure metadata that only InvTweaks itself reads via reflection. */
