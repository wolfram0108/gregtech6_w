...
/** Compile-only mirror of the NEI API: only the static GT_RectHandler calls; its parameter is
 *  Object because the caller is already blocked by the missing client-side GuiContainer class. */
