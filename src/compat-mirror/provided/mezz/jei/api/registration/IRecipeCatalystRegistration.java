...
public interface IRecipeCatalystRegistration {
	void addRecipeCatalysts(mezz.jei.api.recipe.RecipeType<?> a0, net.minecraft.world.level.ItemLike... a1);
	default void addRecipeCatalysts(mezz.jei.api.recipe.RecipeType<?> a0, net.minecraft.world.item.ItemStack... a1) { throw new UnsupportedOperationException(); }
}
