...
public interface ISubtypeRegistration {
	default void registerSubtypeInterpreter(net.minecraft.world.item.Item a0, mezz.jei.api.ingredients.subtypes.IIngredientSubtypeInterpreter<net.minecraft.world.item.ItemStack> a1) { throw new UnsupportedOperationException(); }
}
