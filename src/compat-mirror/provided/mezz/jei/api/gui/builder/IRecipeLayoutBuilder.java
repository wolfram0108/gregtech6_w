...
public interface IRecipeLayoutBuilder {
	default mezz.jei.api.gui.builder.IRecipeSlotBuilder addInputSlot(int a0, int a1) { throw new UnsupportedOperationException(); }
	default mezz.jei.api.gui.builder.IRecipeSlotBuilder addOutputSlot(int a0, int a1) { throw new UnsupportedOperationException(); }
	void createFocusLink(mezz.jei.api.gui.builder.IIngredientAcceptor<?>... a0);
}
