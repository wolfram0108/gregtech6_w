...
public interface IIngredientAcceptor<THIS extends mezz.jei.api.gui.builder.IIngredientAcceptor<THIS>> extends mezz.jei.api.gui.builder.IIngredientConsumer {
	default THIS addItemStacks(java.util.List<net.minecraft.world.item.ItemStack> a0) { throw new UnsupportedOperationException(); }
	default THIS addItemStack(net.minecraft.world.item.ItemStack a0) { throw new UnsupportedOperationException(); }
}
