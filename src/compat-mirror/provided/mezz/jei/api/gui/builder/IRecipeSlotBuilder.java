...
public interface IRecipeSlotBuilder extends mezz.jei.api.gui.builder.IIngredientAcceptor<mezz.jei.api.gui.builder.IRecipeSlotBuilder>, mezz.jei.api.gui.placement.IPlaceable<mezz.jei.api.gui.builder.IRecipeSlotBuilder> {
	mezz.jei.api.gui.builder.IRecipeSlotBuilder addRichTooltipCallback(mezz.jei.api.gui.ingredient.IRecipeSlotRichTooltipCallback a0);
}
