...
public interface IDrawableStatic extends mezz.jei.api.gui.drawable.IDrawable {
	void draw(net.minecraft.client.gui.GuiGraphics a0, int a1, int a2, int a3, int a4, int a5, int a6);
}
