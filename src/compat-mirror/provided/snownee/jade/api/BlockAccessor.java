...
public interface BlockAccessor extends snownee.jade.api.Accessor<net.minecraft.world.phys.BlockHitResult> {
	...
	public interface Builder {
		snownee.jade.api.BlockAccessor.Builder blockState(net.minecraft.world.level.block.state.BlockState a0);
		snownee.jade.api.BlockAccessor.Builder from(snownee.jade.api.BlockAccessor a0);
		snownee.jade.api.BlockAccessor build();
	}
}
