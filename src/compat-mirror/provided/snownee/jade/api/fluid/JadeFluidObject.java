...
public class JadeFluidObject {
	public static snownee.jade.api.fluid.JadeFluidObject empty() { throw new UnsupportedOperationException(); }
	public static snownee.jade.api.fluid.JadeFluidObject of(net.minecraft.world.level.material.Fluid a0, long a1, net.minecraft.nbt.CompoundTag a2) { throw new UnsupportedOperationException(); }
}
