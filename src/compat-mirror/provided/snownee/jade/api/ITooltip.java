...
public interface ITooltip {
	default void add(net.minecraft.network.chat.Component a0) { throw new UnsupportedOperationException(); }
	default void add(java.util.List<snownee.jade.api.ui.IElement> a0) { throw new UnsupportedOperationException(); }
	default void append(int a0, java.util.List<snownee.jade.api.ui.IElement> a1) { throw new UnsupportedOperationException(); }
}
