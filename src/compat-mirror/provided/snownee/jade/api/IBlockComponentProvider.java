...
public interface IBlockComponentProvider extends snownee.jade.api.IToggleableProvider {
	void appendTooltip(snownee.jade.api.ITooltip a0, snownee.jade.api.BlockAccessor a1, snownee.jade.api.config.IPluginConfig a2);
}
