...
public interface IWailaPlugin {
	default void register(snownee.jade.api.IWailaCommonRegistration a0) { throw new UnsupportedOperationException(); }
	default void registerClient(snownee.jade.api.IWailaClientRegistration a0) { throw new UnsupportedOperationException(); }
}
