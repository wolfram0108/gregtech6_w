...
public interface IServerExtensionProvider<IN, OUT> extends snownee.jade.api.IJadeProvider {
	java.util.List<snownee.jade.api.view.ViewGroup<OUT>> getGroups(net.minecraft.server.level.ServerPlayer a0, net.minecraft.server.level.ServerLevel a1, IN a2, boolean a3);
}
