...
public class ClientViewGroup<T> {
	public static <IN, OUT> java.util.List<snownee.jade.api.view.ClientViewGroup<OUT>> map(java.util.List<snownee.jade.api.view.ViewGroup<IN>> a0, java.util.function.Function<IN, OUT> a1, java.util.function.BiConsumer<snownee.jade.api.view.ViewGroup<IN>, snownee.jade.api.view.ClientViewGroup<OUT>> a2) { throw new UnsupportedOperationException(); }
}
