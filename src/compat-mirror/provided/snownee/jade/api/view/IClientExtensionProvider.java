...
public interface IClientExtensionProvider<IN, OUT> extends snownee.jade.api.IJadeProvider {
	java.util.List<snownee.jade.api.view.ClientViewGroup<OUT>> getClientGroups(snownee.jade.api.Accessor<?> a0, java.util.List<snownee.jade.api.view.ViewGroup<IN>> a1);
}
