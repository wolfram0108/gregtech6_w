...
public class FluidView {
	public static snownee.jade.api.view.FluidView readDefault(net.minecraft.nbt.CompoundTag a0) { throw new UnsupportedOperationException(); }
	public static net.minecraft.nbt.CompoundTag writeDefault(snownee.jade.api.fluid.JadeFluidObject a0, long a1) { throw new UnsupportedOperationException(); }
}
