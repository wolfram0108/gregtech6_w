...
public interface ToolHandler {
	net.minecraft.world.item.ItemStack test(net.minecraft.world.level.block.state.BlockState a0, net.minecraft.world.level.Level a1, net.minecraft.core.BlockPos a2);
	java.util.List<net.minecraft.world.item.ItemStack> getTools();
