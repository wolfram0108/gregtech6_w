...
public class Platform {
	public static boolean hasPermissions(appeng.api.util.DimensionalBlockPos a0, net.minecraft.world.entity.player.Player a1) { throw new UnsupportedOperationException(); }
}
