...
public interface WireConnector {
	boolean canConnectToAdjacentWire(net.minecraft.world.level.BlockGetter a0, net.minecraft.core.BlockPos a1, net.minecraft.world.level.block.state.BlockState a2, net.minecraft.core.BlockPos a3, net.minecraft.world.level.block.state.BlockState a4, net.minecraft.core.Direction a5, net.minecraft.core.Direction a6);
}
