...
public final class MoreRedAPI {
	public static java.util.Map<net.minecraft.world.level.block.Block, commoble.morered.api.WireConnector> getWireConnectabilityRegistry() { throw new UnsupportedOperationException(); }
	public static commoble.morered.api.WireConnector getDefaultWireConnector() { throw new UnsupportedOperationException(); }
}
